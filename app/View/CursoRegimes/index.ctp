<div class="cursoRegimes index">
	...
	<tr>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $cursoRegime['CursoRegime']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $cursoRegime['CursoRegime']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $cursoRegime['CursoRegime']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $cursoRegime['CursoRegime']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
