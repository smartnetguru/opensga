<?php
App::uses('ArtigoEstadoArtigosController', 'Controller');

/**
 * ArtigoEstadoArtigosController Test Case
 */
class ArtigoEstadoArtigosControllerTest extends ControllerTestCase {
