<div class="candidatoGraduacaos index">
	...
	<tr>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $candidatoGraduacao['CandidatoGraduacao']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $candidatoGraduacao['CandidatoGraduacao']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $candidatoGraduacao['CandidatoGraduacao']['id']), null, __('Are you sure you want to delete # %s?', $candidatoGraduacao['CandidatoGraduacao']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
