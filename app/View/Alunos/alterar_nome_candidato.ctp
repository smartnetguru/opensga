    ...
    <div class="grid_12">
        ...
        <div class="grid_12">
            <div class="block-border">
                ...
                <?php echo $this->Form->create('Candidatura', array('enctype' => 'multipart/form-data','class' => 'block-content form', 'inputDefaults' => array('before' => '<p>', 'after' => '</p>'))); ?>
                <?php echo $this->Form->input('apelido', array('label' => __('Novo Apelido'), 'div' => '_25', 'class' => 'text','value'=>$candidato['Candidatura']['apelido'])); ?>
                <?php echo $this->Form->input('nomes', array('label' => __('Novo Nome'), 'div' => '_75', 'class' => 'text','value'=>$candidato['Candidatura']['nomes'])); ?>
