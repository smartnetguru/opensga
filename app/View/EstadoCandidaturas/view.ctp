<div class="estadoCandidaturas view">
<h2><?php echo __('Estado Candidatura'); ?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($estadoCandidatura['EstadoCandidatura']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Name'); ?></dt>
		<dd>
			<?php echo h($estadoCandidatura['EstadoCandidatura']['name']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Estado Candidatura'), array('action' => 'edit', $estadoCandidatura['EstadoCandidatura']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Estado Candidatura'), array('action' => 'delete', $estadoCandidatura['EstadoCandidatura']['id']), null, __('Are you sure you want to delete # %s?', $estadoCandidatura['EstadoCandidatura']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('List Estado Candidaturas'), array('action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(__('New Estado Candidatura'), array('action' => 'add')); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($estadoCandidatura['CandidatoGraduacao'])): ?>
	...
	<?php foreach ($estadoCandidatura['CandidatoGraduacao'] as $candidatoGraduacao): ?>
		<tr>
			...
			<td class="actions">
				...
				<?php echo $this->Form->postLink(__('Delete'), array('controller' => 'candidato_graduacaos', 'action' => 'delete', $candidatoGraduacao['id']), null, __('Are you sure you want to delete # %s?', $candidatoGraduacao['id'])); ?>
			</td>
		</tr>
	<?php endforeach; ?>
	</table>
