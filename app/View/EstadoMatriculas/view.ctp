...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Estado Matricula'), array('action' => 'edit', $estadoMatricula['EstadoMatricula']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Estado Matricula'), array('action' => 'delete', $estadoMatricula['EstadoMatricula']['id']), array(), __('Are you sure you want to delete # %s?', $estadoMatricula['EstadoMatricula']['id'])); ?> </li>
...
<div class="related">
	...
	<?php foreach ($estadoMatricula['Candidatura'] as $candidatura): ?>
		<tr>
			...
			<td class="actions">
				<?php echo $this->Html->link(__('View'), array('controller' => 'candidaturas', 'action' => 'view', $candidatura['id'])); ?>
				<?php echo $this->Html->link(__('Edit'), array('controller' => 'candidaturas', 'action' => 'edit', $candidatura['id'])); ?>
				<?php echo $this->Form->postLink(__('Delete'), array('controller' => 'candidaturas', 'action' => 'delete', $candidatura['id']), array(), __('Are you sure you want to delete # %s?', $candidatura['id'])); ?>
			</td>
		</tr>
	<?php endforeach; ?>
	</table>
