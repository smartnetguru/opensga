<?php
App::uses('ArtigoAreaPesquisasController', 'Controller');

/**
 * ArtigoAreaPesquisasController Test Case
 */
class ArtigoAreaPesquisasControllerTest extends ControllerTestCase {
