...
<?php echo $this->Form->create('EstadoObjecto'); ?>
	<fieldset>
		<legend><?php echo __('Edit Estado Objecto'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('EstadoObjecto.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('EstadoObjecto.id'))); ?></li>
