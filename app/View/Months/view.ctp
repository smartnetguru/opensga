...
<div class="actions">
    ...
    <ul>
        <li><?php echo $this->Html->link(__('Edit Month'), ['action' => 'edit', $month['Month']['id']]); ?> </li>
        <li><?php echo $this->Form->postLink(__('Delete Month'), ['action' => 'delete', $month['Month']['id']], null,
                    __('Are you sure you want to delete # %s?', $month['Month']['id'])); ?> </li>
        <li><?php echo $this->Html->link(__('List Months'), ['action' => 'index']); ?> </li>
        <li><?php echo $this->Html->link(__('New Month'), ['action' => 'add']); ?> </li>
                    ...
                    <tr>
                        ...
                        <td class="actions">
                            <?php echo $this->Html->link(__('View'), [
                                    'controller' => 'escolas_tipopagamentos',
                                    'action'     => 'view',
                                    $escolasTipopagamento['id'],
                            ]); ?>
                            ...
                            <?php echo $this->Form->postLink(__('Delete'), [
                                    ...
                                    'action'     => 'delete',
                                    $escolasTipopagamento['id'],
                            ], null, __('Are you sure you want to delete # %s?', $escolasTipopagamento['id'])); ?>
                        </td>
                    </tr>
                <?php endforeach; ?>
        </table>
...
<div class="related">
            ...
            <?php
                ...
                foreach ($month['Feriado'] as $feriado): ?>
                    <tr>
                        ...
                        <td class="actions">
                            <?php echo $this->Html->link(__('View'),
                                    ['controller' => 'feriados', 'action' => 'view', $feriado['id']]); ?>
                            <?php echo $this->Html->link(__('Edit'),
                                    ['controller' => 'feriados', 'action' => 'edit', $feriado['id']]); ?>
                            <?php echo $this->Form->postLink(__('Delete'),
                                    ['controller' => 'feriados', 'action' => 'delete', $feriado['id']], null,
                                    __('Are you sure you want to delete # %s?', $feriado['id'])); ?>
                        </td>
                    </tr>
                <?php endforeach; ?>
        </table>
    ...
    <div class="actions">
        <ul>
            <li><?php echo $this->Html->link(__('New Feriado'),
                        ['controller' => 'feriados', 'action' => 'add']); ?> </li>
        </ul>
    </div>
</div>
<div class="related">
            ...
            <?php
                ...
                foreach ($month['Mensalidade'] as $mensalidade): ?>
                    <tr>
                        ...
                        <td class="actions">
                            <?php echo $this->Html->link(__('View'),
                                    ['controller' => 'mensalidades', 'action' => 'view', $mensalidade['id']]); ?>
                            <?php echo $this->Html->link(__('Edit'),
                                    ['controller' => 'mensalidades', 'action' => 'edit', $mensalidade['id']]); ?>
                            <?php echo $this->Form->postLink(__('Delete'),
                                    ['controller' => 'mensalidades', 'action' => 'delete', $mensalidade['id']], null,
            ...
            <?php
                ...
                foreach ($month['Tipopagamento'] as $tipopagamento): ?>
                    <tr>
                        ...
                        <td class="actions">
                            <?php echo $this->Html->link(__('View'),
                                    ['controller' => 'tipopagamentos', 'action' => 'view', $tipopagamento['id']]); ?>
                            <?php echo $this->Html->link(__('Edit'),
                                    ['controller' => 'tipopagamentos', 'action' => 'edit', $tipopagamento['id']]); ?>
                            <?php echo $this->Form->postLink(__('Delete'),
                                    ['controller' => 'tipopagamentos', 'action' => 'delete', $tipopagamento['id']],
                                    null, __('Are you sure you want to delete # %s?', $tipopagamento['id'])); ?>
                        </td>
                    </tr>
                <?php endforeach; ?>
        </table>
