            ...
            <tr>
                ...
                <td class="actions">
                    <?php echo $this->Html->link(__('View'),
                            ['action' => 'view', $unidadeOrganicaRole['UnidadeOrganicaRole']['id']]); ?>
                    <?php echo $this->Html->link(__('Edit'),
                            ['action' => 'edit', $unidadeOrganicaRole['UnidadeOrganicaRole']['id']]); ?>
                    <?php echo $this->Form->postLink(__('Delete'),
                            ['action' => 'delete', $unidadeOrganicaRole['UnidadeOrganicaRole']['id']], null,
                            __('Are you sure you want to delete # %s?',
                                    $unidadeOrganicaRole['UnidadeOrganicaRole']['id'])); ?>
                </td>
            </tr>
        <?php endforeach; ?>
    </table>
