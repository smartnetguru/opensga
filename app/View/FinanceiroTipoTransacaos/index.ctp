<div class="financeiroTipoTransacaos index">
	...
	<tr>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $financeiroTipoTransacao['FinanceiroTipoTransacao']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $financeiroTipoTransacao['FinanceiroTipoTransacao']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $financeiroTipoTransacao['FinanceiroTipoTransacao']['id']), null, __('Are you sure you want to delete # %s?', $financeiroTipoTransacao['FinanceiroTipoTransacao']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
