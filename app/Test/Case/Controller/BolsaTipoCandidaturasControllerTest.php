<?php
App::uses('BolsaTipoCandidaturasController', 'Controller');

/**
 * BolsaTipoCandidaturasController Test Case
 *
 */
class BolsaTipoCandidaturasControllerTest extends ControllerTestCase {
