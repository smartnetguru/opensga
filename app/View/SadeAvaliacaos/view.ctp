...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Sade Avaliacao'), array('action' => 'edit', $sadeAvaliacao['SadeAvaliacao']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Sade Avaliacao'), array('action' => 'delete', $sadeAvaliacao['SadeAvaliacao']['id']), null, __('Are you sure you want to delete # %s?', $sadeAvaliacao['SadeAvaliacao']['id'])); ?> </li>
