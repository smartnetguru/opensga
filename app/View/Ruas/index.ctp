    ...
    <table cellpadding="0" cellspacing="0">
        ...
        <?php foreach ($ruas as $rua): ?>
            <tr>
                ...
                <td class="actions">
                    <?php echo $this->Html->link(__('View'), ['action' => 'view', $rua['Rua']['id']]); ?>
                    <?php echo $this->Html->link(__('Edit'), ['action' => 'edit', $rua['Rua']['id']]); ?>
                    <?php echo $this->Form->postLink(__('Delete'), ['action' => 'delete', $rua['Rua']['id']], null,
                            __('Are you sure you want to delete # %s?', $rua['Rua']['id'])); ?>
                </td>
            </tr>
        <?php endforeach; ?>
    </table>
