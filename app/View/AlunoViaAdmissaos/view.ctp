...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Aluno Via Admissao'), array('action' => 'edit', $alunoViaAdmissao['AlunoViaAdmissao']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Aluno Via Admissao'), array('action' => 'delete', $alunoViaAdmissao['AlunoViaAdmissao']['id']), null, __('Are you sure you want to delete # %s?', $alunoViaAdmissao['AlunoViaAdmissao']['id'])); ?> </li>
