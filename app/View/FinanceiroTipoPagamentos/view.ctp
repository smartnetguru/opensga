...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Financeiro Tipo Pagamento'), array('action' => 'edit', $financeiroTipoPagamento['FinanceiroTipoPagamento']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Financeiro Tipo Pagamento'), array('action' => 'delete', $financeiroTipoPagamento['FinanceiroTipoPagamento']['id']), null, __('Are you sure you want to delete # %s?', $financeiroTipoPagamento['FinanceiroTipoPagamento']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('List Financeiro Tipo Pagamentos'), array('action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(__('New Financeiro Tipo Pagamento'), array('action' => 'add')); ?> </li>
