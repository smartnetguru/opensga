...
<div class="actions">
    ...
    <ul>
        <li><?php echo $this->Html->link(__('Edit Financeiro Estado Deposito'),
                    ['action' => 'edit', $financeiroEstadoDeposito['FinanceiroEstadoDeposito']['id']]); ?> </li>
        <li><?php echo $this->Form->postLink(__('Delete Financeiro Estado Deposito'),
                    ['action' => 'delete', $financeiroEstadoDeposito['FinanceiroEstadoDeposito']['id']], null,
                    __('Are you sure you want to delete # %s?',
                            $financeiroEstadoDeposito['FinanceiroEstadoDeposito']['id'])); ?> </li>
        <li><?php echo $this->Html->link(__('List Financeiro Estado Depositos'), ['action' => 'index']); ?> </li>
