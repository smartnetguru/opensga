<?php
App::uses('BolsaTipoCandidatura', 'Model');

/**
 * BolsaTipoCandidatura Test Case
 *
 */
class BolsaTipoCandidaturaTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->BolsaTipoCandidatura = ClassRegistry::init('BolsaTipoCandidatura');
	}
 ...
 */
	public function tearDown() {
		unset($this->BolsaTipoCandidatura);
