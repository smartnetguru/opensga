<div class="notificationUsers index">
	...
	<tr>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $notificationUser['NotificationUser']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $notificationUser['NotificationUser']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $notificationUser['NotificationUser']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $notificationUser['NotificationUser']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
