    ...
    public function docente(){
        if($this->request->is('post') || $this->request->is('put')){
            ...
            foreach($respostas as $k=>$v){
                ...
                $avaliacao_antiga = $this->SadeAutoAvaliacao->find('first',array('conditions'=>array('SadeAutoAvaliacao.sade_parametro_id'=>$k,'SadeAutoAvaliacao.entidade_id'=>$entidade['Entidade']['id'],'SadeAutoAvaliacao.ano_lectivo_id'=>$this->Session->read('SGAConfig.ano_lectivo_id'))));
        ...
        $avaliacao_antiga = $this->SadeAutoAvaliacao->find('all',array('conditions'=>array('SadeAutoAvaliacao.entidade_id'=>$entidade['Entidade']['id'],'SadeAutoAvaliacao.ano_lectivo_id'=>$this->Session->read('SGAConfig.ano_lectivo_id'))));
