...
// Variables on different parts of document
    ...
    $templateProcessor->setValue('distritoNascimento',
        $historicoCurso['Aluno']['Entidade']['CidadeNascimento']['name']);
    $templateProcessor->setValue('provinciaNascimento',
        $historicoCurso['Aluno']['Entidade']['ProvinciaNascimento']['name']);
