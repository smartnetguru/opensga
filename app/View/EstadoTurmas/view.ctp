...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Estado Turma'), array('action' => 'edit', $estadoTurma['EstadoTurma']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Estado Turma'), array('action' => 'delete', $estadoTurma['EstadoTurma']['id']), array(), __('Are you sure you want to delete # %s?', $estadoTurma['EstadoTurma']['id'])); ?> </li>
