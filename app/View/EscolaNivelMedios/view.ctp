...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Escola Nivel Medio'), array('action' => 'edit', $escolaNivelMedio['EscolaNivelMedio']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Escola Nivel Medio'), array('action' => 'delete', $escolaNivelMedio['EscolaNivelMedio']['id']), null, __('Are you sure you want to delete # %s?', $escolaNivelMedio['EscolaNivelMedio']['id'])); ?> </li>
...
<div class="related">
	...
	<?php
		...
		<tr>
			...
			<td class="actions">
				<?php echo $this->Html->link(__('View'), array('controller' => 'aluno_nivel_medios', 'action' => 'view', $alunoNivelMedio['id'])); ?>
				<?php echo $this->Html->link(__('Edit'), array('controller' => 'aluno_nivel_medios', 'action' => 'edit', $alunoNivelMedio['id'])); ?>
				<?php echo $this->Form->postLink(__('Delete'), array('controller' => 'aluno_nivel_medios', 'action' => 'delete', $alunoNivelMedio['id']), null, __('Are you sure you want to delete # %s?', $alunoNivelMedio['id'])); ?>
			</td>
		</tr>
	<?php endforeach; ?>
	</table>
