...
<div class="projectos index" id="center-column">
    <div class="top-bar">
        <?php echo $this->Html->link(sprintf(__('Novo Tipo de Movimento', true)), ['action' => 'add'],
                ['class' => 'button']); ?>
                    ...
                    <tr<?php echo $class; ?>>
                        ...
                        <td class="accoes">
                            <?php echo $this->Html->image("/img/login-icon.gif", [
                                    "alt"   => "Brownies",
                                    "title" => "Visualizar",
                                    'url'   => ['action' => 'view', $tg0015tipomovimento['Tg0015tipomovimento']['id']],
                            ]); ?>
                            <?php echo $this->Html->image("/img/edit-icon.gif", [
                                    "alt"   => "Brownies",
                                    "title" => "Editar",
                                    'url'   => ['action' => 'edit', $tg0015tipomovimento['Tg0015tipomovimento']['id']],
                            ]); ?>
                            <?php echo $this->Html->image("/img/hr.gif", [
                                    ...
                                    'url'   => [
                                            'action' => 'delete',
                                            $tg0015tipomovimento['Tg0015tipomovimento']['id'],
                                    ],
                                    null,
