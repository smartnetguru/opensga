<div class="estadoCandidaturas index">
	...
	<tr>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $estadoCandidatura['EstadoCandidatura']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $estadoCandidatura['EstadoCandidatura']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $estadoCandidatura['EstadoCandidatura']['id']), null, __('Are you sure you want to delete # %s?', $estadoCandidatura['EstadoCandidatura']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
