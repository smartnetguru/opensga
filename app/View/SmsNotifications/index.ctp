<div class="smsNotifications index">
	...
	<tr>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $smsNotification['SmsNotification']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $smsNotification['SmsNotification']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $smsNotification['SmsNotification']['id']), null, __('Are you sure you want to delete # %s?', $smsNotification['SmsNotification']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
