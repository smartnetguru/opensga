                ...
                <div class="panel-body">
                    <div class="col-sm-12">
                        ...
                        <div class="col-sm-2"    style="margin-top: 25px; margin-left: -50px;" >
                            <button type="button"  id="button_pesquisa"  class="btn btn-default pull-right"> Pesquisar</button>
                        </div>
                    </div> 
                            ...
                            <form role="form" class="form-horizontal">
                                <div class="col-sm-8">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" readonly="true" placeholder="" id="apelido" value="" name="apelido" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" id="nomes" name="nomes"  readonly="true" class="form-control">
                                        </div>
                                    </div>
                                    <!--============================================-->
                                    ...
                                    <div class="form-group" >
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" id="curso" name="curso" readonly="true" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" value=""  readonly="true" id="ano_lectivo_admissao" name="ano_lectivo_admissao" class="form-control">
                                        </div>
                                        <label class="col-sm-2 control-label">
                                            Sexo
                                        </label>
                                        <div class="col-sm-3">
                                            <input type="text" placeholder="" readonly="true" id="sexo" value="" name="sexo" class="form-control">
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            <input type="text" value=""  readonly="true" id="nacionalidade" name="nacionalidade" class="form-control">
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <input type="text" value=""  readonly="true" id="provincia_nascimento" name="provincia_nascimento" class="form-control">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            <input type="text" value="" id="data_nascimento" readonly="true" name="data_nascimento" class="form-control">
                                    ...
                                    <div class="panel  panel-success">
                                        <div class="panel-body">
                                            ...
                                            <div class="col-sm-12 botao_guarda"    style="margin-top:10px;">
                                                <button type="button" id="botao_guardar"  class="btn btn-bricky  btn-squared btn-lg btn-block" >
                                                    Guardar
                                                </button>
                                            </div>
                                        </div>
            ...
            <div class="" id="insucesso_pesquisa" hidden >
                <div class="alert alert-block alert-danger fade in">
                    ...
                    <p style="font-size: 15px;">
                        A pesquisa  "<b id="resultado_error" style="font-size: 20px;"></b>"  não retornou nenhum resultado.
                    </p>
                    <p>
                        Sugestões:
                    <ul>
...
<script type="text/javascript">
    ...
    jQuery(document).ready(function() {
        ...
        $('div.botao_guarda #botao_guardar').click(function() {
            if ( tipo_bolsa() == true && alinea() == true) {
                ...
                var numero_candidato =  $('div#hidden_input_ input#numero_candidato').val();
                 ...
                 var array_send = { apelido:apelido,nomes:nomes,numero_candidato:numero_candidato, distrito_id: distrito_id,numero_estudante: numero_estudante, candidatura_id:candidatura_id, curso_id: curso_id, doador: doador, bolsa_tipo_bolsa_id: tipo_bolsa_, alinea: alinea_};
                $.ajax({
                    type: "POST",
                    data: array_send,
                    url: "<?php echo $this->Html->url(array('controller' => 'BolsaTemporarias', 'action' => 'add')) ?>",
                    dataType: "html",
                    cache: false,
        ...
        $('#button_pesquisa').click(function() {
                ...
                var id = {numero: $("div#descritivo div#pulsate-regula #INPUT_numero").val(),nome:$("div#descritivo div#pulsate-regula #INPUT_nome").val(), apelido:$("div#descritivo div#pulsate-regula #INPUT_apelido").val() };

                $.ajax({
                    type: "POST",
                    data: id,
                    url: "<?php echo $this->Html->url(array('controller' => 'BolsaBolsas', 'action' => 'atribuir_bolsas')) ?>",
                    dataType: "html",
                    cache: false,
                    success: function(result) {
                        ...
                        if (result1.invalido != 'Invalido') {
                            ...
                            if (result1.candidatos.Candidatura.nacionalidade == 2) {
