...
<div class="actions">
    ...
    <ul>
        <li><?php echo $this->Html->link(__('Edit Message Folder'),
                    ['action' => 'edit', $messageFolder['MessageFolder']['id']]); ?> </li>
        <li><?php echo $this->Form->postLink(__('Delete Message Folder'),
                ...
                <tr>
                    ...
                    <td class="actions">
                        <?php echo $this->Html->link(__('View'),
                                ['controller' => 'message_users', 'action' => 'view', $messageUser['id']]); ?>
                        <?php echo $this->Html->link(__('Edit'),
                                ['controller' => 'message_users', 'action' => 'edit', $messageUser['id']]); ?>
                        <?php echo $this->Form->postLink(__('Delete'),
                                ['controller' => 'message_users', 'action' => 'delete', $messageUser['id']],
                                ['confirm' => __('Are you sure you want to delete # %s?', $messageUser['id'])]); ?>
                    </td>
                </tr>
            <?php endforeach; ?>
        </table>
