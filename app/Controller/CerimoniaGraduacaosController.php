<?php
    ...
    class CerimoniaGraduacaosController extends AppController
    {
        ...
        public function estudante_inscricao()
        {
            ...
            $this->set(compact('aluno', 'paises', 'provincias', 'cidadeNascimentos', 'generos', 'naturalidade',
                'estadoCivil', 'regimeEstudos', 'regaliaSocials'));
        }
        ...
        public function estudante_pagamento_inscricao()
        {
            ...
            $candidatoGraduacao = $this->CerimoniaGraduacao->CandidatoGraduacao->findByAlunoIdAndCerimoniaGraduacaoId($aluno['Aluno']['id'],
        ...
        public function inscrever_aluno($alunoId)
        {
            ...
            $aluno = $this->CerimoniaGraduacao->CandidatoGraduacao->Aluno->getAlunoForAction($alunoId);
