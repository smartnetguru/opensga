...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Bolsa Tipo Bolsa'), array('action' => 'edit', $bolsaTipoBolsa['BolsaTipoBolsa']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Bolsa Tipo Bolsa'), array('action' => 'delete', $bolsaTipoBolsa['BolsaTipoBolsa']['id']), null, __('Are you sure you want to delete # %s?', $bolsaTipoBolsa['BolsaTipoBolsa']['id'])); ?> </li>
...
<div class="related">
	...
	<?php
		...
		<tr>
			...
			<td class="actions">
				<?php echo $this->Html->link(__('View'), array('controller' => 'bolsa_valor_bolsas', 'action' => 'view', $bolsaValorBolsa['id'])); ?>
				<?php echo $this->Html->link(__('Edit'), array('controller' => 'bolsa_valor_bolsas', 'action' => 'edit', $bolsaValorBolsa['id'])); ?>
				<?php echo $this->Form->postLink(__('Delete'), array('controller' => 'bolsa_valor_bolsas', 'action' => 'delete', $bolsaValorBolsa['id']), null, __('Are you sure you want to delete # %s?', $bolsaValorBolsa['id'])); ?>
			</td>
		</tr>
	<?php endforeach; ?>
	</table>
