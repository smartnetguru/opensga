    ...
    <div class="grid_6">
        ...
        <div class="grid_6">
            <div class="block-border">
                ...
                <?php echo $this->Form->create('CandidatoGraduacao', array('enctype' => 'multipart/form-data','class' => 'block-content form', 'inputDefaults' => array('before' => '<p>', 'after' => '</p>'))); ?>
                
                <?php echo $this->Form->input('ano_conclusao', array('type'=>'text','label' => __('Ano de Conclusão da Parte Curricular'), 'div' => '_30', 'class' => 'text')); ?>
                <?php echo $this->Form->input('data_defesa', array('type'=>'text','label' => __('Data da Defesa'), 'div' => '_30', 'class' => 'required', 'id'=>'dataDefesa')); ?>
                <?php echo $this->Form->input('media_defesa', array('label' => __('Média'), 'div' => '_30', 'class' => 'text')); ?>
                <div class="clear"></div>
                <?php echo $this->Form->input('data_nascimento', array('type'=>'text','label' => __('Data de Nascimento'), 'div' => '_30', 'class' => 'required', 'id'=>'dataNascimento','default'=>$aluno['Entidade']['data_nascimento'])); ?>
                <?php echo $this->Form->input('genero_id', array('options'=>$generos,'label' => __('Sexo'), 'div' => '_30', 'class' => 'required','default'=>$aluno['Entidade']['genero_id'])); ?>
                <?php echo $this->Form->input('estado_civil_id', array('options'=>$estado_civil,'label' => __('Estado Civil'), 'div' => '_30', 'class' => 'required','default'=>$aluno['Entidade']['estado_civil'])); ?>
                <div class="clear"></div>
                <?php echo $this->Form->input('pais_nascimento', array('options'=>$paises,'label' => __('Pais de Nascimento'), 'div' => '_30', 'class' => 'required','default'=>$aluno['Entidade']['pais_nascimento'])); ?>
                <?php echo $this->Form->input('provincia_nascimento', array('options'=>$provincias,'label' => __('Provincia de Nascimento'), 'div' => '_30', 'class' => 'required','default'=>$aluno['Entidade']['provincia_nascimento'])); ?>
                <?php echo $this->Form->input('distrito_nascimento', array('options'=>$cidades,'label' => __('Distrito de Nascimento'), 'div' => '_30', 'class' => 'required','default'=>$aluno['Entidade']['cidade_nascimento'])); ?>
                <div class="clear"></div>
                <?php echo $this->Form->input('regime_estudo_id', array('label' => __('Tipo de Estudante'), 'div' => '_30', 'class' => 'required')); ?>
                <?php echo $this->Form->input('regalia_social_id', array('label' => __('Regalia Social'), 'div' => '_30', 'class' => 'required')); ?>
                <?php echo $this->Form->input('telemovel', array('label' => __('Telemóvel'), 'div' => '_30', 'class' => 'required','default'=>$aluno['Entidade']['telemovel'])); ?>
                
                <?php echo $this->Form->input('data_candidatura', array('type'=>'text','label' => __('Data de Candidatura'), 'div' => '_50', 'class' => 'required','id'=>'dataCandidatura')); ?>
                <?php echo $this->Form->input('cerimonia_graduacao_id', array('label' => __('Cerimónia de Graduação'), 'div' => '_50', 'class' => 'required')); ?>
