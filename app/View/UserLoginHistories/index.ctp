<div class="userLoginHistories index">
	...
	<tr>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $userLoginHistorie['UserLoginHistorie']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $userLoginHistorie['UserLoginHistorie']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $userLoginHistorie['UserLoginHistorie']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $userLoginHistorie['UserLoginHistorie']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
