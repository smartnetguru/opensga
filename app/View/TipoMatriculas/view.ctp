<div class="tipoMatriculas view">
<h2><?php echo __('Tipo Matricula'); ?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($tipoMatricula['TipoMatricula']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Name'); ?></dt>
		<dd>
			<?php echo h($tipoMatricula['TipoMatricula']['name']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Tipo Matricula'), array('action' => 'edit', $tipoMatricula['TipoMatricula']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Tipo Matricula'), array('action' => 'delete', $tipoMatricula['TipoMatricula']['id']), array(), __('Are you sure you want to delete # %s?', $tipoMatricula['TipoMatricula']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('List Tipo Matriculas'), array('action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(__('New Tipo Matricula'), array('action' => 'add')); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($tipoMatricula['Matricula'])): ?>
	...
	<?php foreach ($tipoMatricula['Matricula'] as $matricula): ?>
		<tr>
