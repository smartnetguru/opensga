<?php
App::uses('FinanceiroTipoPagamentosController', 'Controller');

/**
 * FinanceiroTipoPagamentosController Test Case
 *
 */
class FinanceiroTipoPagamentosControllerTest extends ControllerTestCase {
