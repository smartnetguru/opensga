<div class="epocaAvaliacaos index">
	...
	<tr>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $epocaAvaliacao['EpocaAvaliacao']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $epocaAvaliacao['EpocaAvaliacao']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $epocaAvaliacao['EpocaAvaliacao']['id']), array(), __('Are you sure you want to delete # %s?', $epocaAvaliacao['EpocaAvaliacao']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
