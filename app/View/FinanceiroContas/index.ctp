<div class="financeiroContas index">
	...
	<tr>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $financeiroConta['FinanceiroConta']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $financeiroConta['FinanceiroConta']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $financeiroConta['FinanceiroConta']['id']), null, __('Are you sure you want to delete # %s?', $financeiroConta['FinanceiroConta']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
