...
<?php echo $this->Form->create('BolsaTipoBolsa'); ?>
	<fieldset>
		<legend><?php echo __('Edit Bolsa Tipo Bolsa'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('BolsaTipoBolsa.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('BolsaTipoBolsa.id'))); ?></li>
