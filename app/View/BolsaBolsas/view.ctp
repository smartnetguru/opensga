    ...
    <dl>
        ...
        <dd>
            <?php echo $this->Html->link($bolsaBolsa['BolsaPedido']['id'],
                    ['controller' => 'bolsa_candidaturas', 'action' => 'view', $bolsaBolsa['BolsaPedido']['id']]); ?>
            &nbsp;
        </dd>
        <dt><?php echo __('AnoLectivo'); ?></dt>
        <dd>
            <?php echo $this->Html->link($bolsaBolsa['AnoLectivo']['codigo'],
                    ['controller' => 'anolectivos', 'action' => 'view', $bolsaBolsa['AnoLectivo']['id']]); ?>
            &nbsp;
        </dd>
        ...
        <dd>
            <?php echo $this->Html->link($bolsaBolsa['BolsaResultado']['id'],
                    ['controller' => 'bolsa_resultados', 'action' => 'view', $bolsaBolsa['BolsaResultado']['id']]); ?>
            &nbsp;
        </dd>
    </dl>
</div>
<div class="actions">
    ...
    <ul>
        <li><?php echo $this->Html->link(__('Edit Bolsa Bolsa'),
                    ['action' => 'edit', $bolsaBolsa['BolsaBolsa']['id']]); ?> </li>
        <li><?php echo $this->Form->postLink(__('Delete Bolsa Bolsa'),
                    ['action' => 'delete', $bolsaBolsa['BolsaBolsa']['id']], null,
                    __('Are you sure you want to delete # %s?', $bolsaBolsa['BolsaBolsa']['id'])); ?> </li>
