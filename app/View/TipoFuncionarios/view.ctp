...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Tipo Funcionario'), array('action' => 'edit', $tipoFuncionario['TipoFuncionario']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Tipo Funcionario'), array('action' => 'delete', $tipoFuncionario['TipoFuncionario']['id']), array(), __('Are you sure you want to delete # %s?', $tipoFuncionario['TipoFuncionario']['id'])); ?> </li>
