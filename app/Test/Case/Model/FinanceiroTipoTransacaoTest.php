<?php
App::uses('FinanceiroTipoTransacao', 'Model');

/**
 * FinanceiroTipoTransacao Test Case
 *
 */
class FinanceiroTipoTransacaoTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->FinanceiroTipoTransacao = ClassRegistry::init('FinanceiroTipoTransacao');
	}
 ...
 */
	public function tearDown() {
		unset($this->FinanceiroTipoTransacao);
