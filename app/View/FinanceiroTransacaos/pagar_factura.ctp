    ...
    <div class="container_12">
                ...
                <div class="block-content form">
                    ...
                    <div class="block-actions">
                        <ul class="actions-left">
                            <li><?php echo $this->Html->link(__('Novo Tipo de Pagamento'),
                                        ['controller' => 'financeiro_pagamentos', 'action' => 'novo_tipo_pagamento'],
                                        ['class' => 'button red']) ?></li>
                        </ul>
        ...
        <div class="grid_6">
            <div class="block-border">
                ...
                <div class="_75">
                    <p>
                        <label for="textfield"><?php echo __('Valor a Pagar') ?></label><?php echo $this->Form->input('FinanceiroPagamento.valor',
                                [
                                        'label' => false,
                                        'div'   => false,
                                        'class' => 'required',
                ...
                <div class="_25">
                    <p>
                        <label for="textfield"><?php echo __('Data') ?></label><?php echo $this->Form->input('FinanceiroPagamento.data_pagamento',
                                [
                                        'label' => false,
                                        'div'   => false,
                                        'class' => 'required',
                ...
                <?php echo $this->Form->input('FinanceiroPagamento.aluno_id',
