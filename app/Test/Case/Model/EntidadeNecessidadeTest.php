<?php
	App::uses('EntidadeNecessidade', 'Model');

	/**
	 * EntidadeNecessidade Test Case
	 */
	class EntidadeNecessidadeTest extends CakeTestCase
	{
		...
		{
			parent::setUp();
			$this->EntidadeNecessidade = ClassRegistry::init('EntidadeNecessidade');
		}
		...
		{
			unset($this->EntidadeNecessidade);
