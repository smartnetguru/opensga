...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Regalia Social'), array('action' => 'edit', $regaliaSocial['RegaliaSocial']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Regalia Social'), array('action' => 'delete', $regaliaSocial['RegaliaSocial']['id']), null, __('Are you sure you want to delete # %s?', $regaliaSocial['RegaliaSocial']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('List Regalia Socials'), array('action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(__('New Regalia Social'), array('action' => 'add')); ?> </li>
