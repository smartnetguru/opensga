<div class="sadeIndicadors index">
	...
	<tr>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $sadeIndicador['SadeIndicador']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $sadeIndicador['SadeIndicador']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $sadeIndicador['SadeIndicador']['id']), null, __('Are you sure you want to delete # %s?', $sadeIndicador['SadeIndicador']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
