...
<div class="actions">
    ...
    <ul>
        <li><?php echo $this->Html->link(__('Edit Opensga Sessiom'),
                    ['action' => 'edit', $opensgaSessiom['OpensgaSessiom']['id']]); ?> </li>
        <li><?php echo $this->Form->postLink(__('Delete Opensga Sessiom'),
