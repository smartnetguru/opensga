...
<div class="actions">
    ...
    <ul>
        <li><?php echo $this->Html->link(__('Edit Tipo Matricula'),
                    ['action' => 'edit', $tipoMatricula['TipoMatricula']['id']]); ?> </li>
        <li><?php echo $this->Form->postLink(__('Delete Tipo Matricula'),
                    ['action' => 'delete', $tipoMatricula['TipoMatricula']['id']], [],
                    __('Are you sure you want to delete # %s?', $tipoMatricula['TipoMatricula']['id'])); ?> </li>
