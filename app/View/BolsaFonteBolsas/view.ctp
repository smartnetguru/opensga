<div class="bolsaFonteBolsas view">
<h2><?php  echo __('Bolsa Fonte Bolsa'); ?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($bolsaFonteBolsa['BolsaFonteBolsa']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Name'); ?></dt>
		<dd>
			<?php echo h($bolsaFonteBolsa['BolsaFonteBolsa']['name']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Bolsa Fonte Bolsa'), array('action' => 'edit', $bolsaFonteBolsa['BolsaFonteBolsa']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Bolsa Fonte Bolsa'), array('action' => 'delete', $bolsaFonteBolsa['BolsaFonteBolsa']['id']), null, __('Are you sure you want to delete # %s?', $bolsaFonteBolsa['BolsaFonteBolsa']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('List Bolsa Fonte Bolsas'), array('action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(__('New Bolsa Fonte Bolsa'), array('action' => 'add')); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($bolsaFonteBolsa['BolsaBolsa'])): ?>
	...
	<?php
		$i = 0;
		foreach ($bolsaFonteBolsa['BolsaBolsa'] as $bolsaBolsa): ?>
		<tr>
