...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Bolsa Resultado'), array('action' => 'edit', $bolsaResultado['BolsaResultado']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Bolsa Resultado'), array('action' => 'delete', $bolsaResultado['BolsaResultado']['id']), null, __('Are you sure you want to delete # %s?', $bolsaResultado['BolsaResultado']['id'])); ?> </li>
