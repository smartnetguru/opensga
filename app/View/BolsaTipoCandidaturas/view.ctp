...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Bolsa Tipo Candidatura'), array('action' => 'edit', $bolsaTipoCandidatura['BolsaTipoCandidatura']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Bolsa Tipo Candidatura'), array('action' => 'delete', $bolsaTipoCandidatura['BolsaTipoCandidatura']['id']), null, __('Are you sure you want to delete # %s?', $bolsaTipoCandidatura['BolsaTipoCandidatura']['id'])); ?> </li>
