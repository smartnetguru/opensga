<?php
App::uses('FinanceiroFormaDepositosController', 'Controller');

/**
 * FinanceiroFormaDepositosController Test Case
 *
 */
class FinanceiroFormaDepositosControllerTest extends ControllerTestCase {
