...
<div class="projectos index" id="center-column">
    <div class="top-bar">
        <?php if ($grupo == 1) {
            echo $this->Html->link(sprintf(__('Nova Avaliacao', true)), ['action' => 'add'], ['class' => 'button']);
        } ?>
	...
	-->
                        <td>
                            <?php echo $this->Html->link($t0018TurmaTipoAvaliacao['TipoAvaliacao']['name'], [
                                    'controller' => 'tipoavaliacaos',
                                    'action'     => 'view',
                                    $t0018TurmaTipoAvaliacao['TipoAvaliacao']['id'],
                            ]); ?>
                        </td>
                        ...
                        <td class="accoes">
                            <?php echo $this->Html->image("/img/login-icon.gif", [
                                    ...
                                    'url' => [
                                            'action' => 'view',
                                            $t0018TurmaTipoAvaliacao['T0018TurmaTipoAvaliacao']['id'],
                                    ],
                            ]); ?>
                            <?php if ($grupo == 1) {
