...
<?php //include('menu.ctp'); ?>
    ...
    <div class="projectos form" id="center-column">
        <div class="top-bar">
            <?php echo $this->Html->link(sprintf(__('Lista de Avaliacoes', true)), ['action' => 'index'],
                    ['class' => 'button']); ?>
        ...
        <div class="table">
            ...
            <?php echo $this->Form->create('Avaliacao', ['id' => 'avaliacaoForm']); ?>
            <table class="listingform" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <?php
                        ...
                        echo $this->Form->input('t0010turma', [
                                'label'   => 'Disciplina',
                                'before'  => '<tr><td>',
                                'between' => '</td><td>',
                                'after'   => '</td></tr>',
            ...
            <div id="estudantesDivId">
                <table class="listingform" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td></td>
                        <td class="full" colspan="4"><?php echo $this->Form->end(__('Gravar', true)); ?></td>
                    </tr>
                </table>
            </div>
        </div>
...
<?php
    $options = ['url' => 'add/', 'update' => 'estudantesDivId', 'indicator' => 'ajax-loader'];
