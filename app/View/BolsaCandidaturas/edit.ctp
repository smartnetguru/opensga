...
<?php echo $this->Form->create('BolsaPedido'); ?>
	<fieldset>
		<legend><?php echo __('Edit Bolsa Candidatura'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('BolsaPedido.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('BolsaPedido.id'))); ?></li>
