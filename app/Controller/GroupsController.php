...
class GroupsController extends AppController {
    ...
    function editar_grupo($id = null) {
        ...
        if ($this->request->is('post') || $this->request->is('put')) {
            if ($this->Group->save($this->request->data)) {
                $this->Session->setFlash(__('Dados editados com sucesso'), 'default', array('class' => 'alert success'));
                $this->redirect(array('action' => 'index'));
            } else {
                $this->Session->setFlash(__('Problemas ao editar grupo. Por favor, tente novamente'), 'default', array('class' => 'alert error'));
            }
        } else {
    ...
    function desactivar_grupo($id = null) {
        ...
        if($this->Group->save()){
            $this->Session->setFlash(__('Objecto desactivado com sucesso'), 'default', array('class' => 'alert success'));
                $this->redirect(array('action' => 'index'));
            } else {
                $this->Session->setFlash(__('Problemas ao desactivar objecto. Por favor, tente novamente'), 'default', array('class' => 'alert error'));
            }
        }
