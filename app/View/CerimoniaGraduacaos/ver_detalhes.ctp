    ...
    <div class="action-list">
        <div class="col-sm-2">
            <?php echo $this->Html->link('<i class="fa fa-user fa-2x"></i>Fazer Inscricao',
                ['controller' => 'alunos', 'action' => 'pesquisa_aluno_action','inscrever_aluno','cerimonia_graduacaos'],
                ['escape' => false, 'class' => 'btn btn-icon btn-block']) ?>

        </div>
        <div class="col-sm-2">
            <?php echo $this->Html->link('<i class="fa fa-print fa-2x"></i>Imprimir Lista de Inscritos',
                ['controller' => 'cerimonia_graduacaos', 'action' => 'print_lista_graduandos',$cerimoniaGraduacaoId],
                ['escape' => false, 'class' => 'btn btn-icon btn-block']) ?>
    ...
    <table id="table-example" class="table">
        ...
        <?php
            ...
            <?php endif;?>
                ...
                <td><?php echo $this->Html->link('Ver Detalhes',['controller'=>'candidato_graduacaos','action'=>'ver_detalhes',$candidato['CandidatoGraduacao']['id']])?></td>
