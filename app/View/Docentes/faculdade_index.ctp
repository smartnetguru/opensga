...
foreach ($docentes as $docente):
    ...
    <tr>
        ...
        <td class="actions">
            <?php echo $this->Html->link(__('Ver', true), ['action' => 'perfil_docente', $docente['Docente']['id']]); ?>
            <?php echo $this->Html->link(__('Editar', true),
                ['action' => 'editar_docente', $docente['Docente']['id']]); ?>
            <?php echo $this->Html->link(__('Delete', true), ['action' => 'delete', $docente['Docente']['id']], null,
