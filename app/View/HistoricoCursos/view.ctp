...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Historico Curso'), array('action' => 'edit', $historicoCurso['HistoricoCurso']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Historico Curso'), array('action' => 'delete', $historicoCurso['HistoricoCurso']['id']), null, __('Are you sure you want to delete # %s?', $historicoCurso['HistoricoCurso']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('List Historico Cursos'), array('action' => 'index')); ?> </li>
