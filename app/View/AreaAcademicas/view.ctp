...
$this->Html->addCrumb(h($areaAcademica['AreaAcademica']['name']), '/tipo_unidade_organicas/view/'.h($areaAcademica['AreaAcademica']['id']));
				...
				<div class="block-border">
					<div class="block-content">
						<ul class="shortcut-list">
							<li>
								<?php echo $this->Html->link($this->Html->image('icons/packs/crystal/48x48/apps/kedit.png').__("Lista de Áreas Académicas"),array('controller'=>'areas_academicas','action'=>'index'),array('escape'=>false)) ?>
							</li>
						</ul>
						<div class="clear"></div>
					</div>
