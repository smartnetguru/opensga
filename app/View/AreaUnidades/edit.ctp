...
$this->Html->addCrumb($this->request->data['AreaUnidade']['name'], '/area_unidades/edit/'.$this->request->data['AreaUnidade']['id']);
...
<div class="container_12">
				...
				<div class="block-border">
					<div class="block-content">
						<ul class="shortcut-list">
							<li>
								<?php echo $this->Html->link($this->Html->image('icons/packs/crystal/48x48/apps/kedit.png').__("Lista de Áreas Funcionais"),array('controller'=>'area_unidades','action'=>'index'),array('escape'=>false)) ?>
							</li>
						</ul>
						<div class="clear"></div>
					</div>
    ...
    <div class="grid_6">
        <div class="block-border">
            ...
            <?php echo $this->Form->create('AreaUnidade', array('class' => 'block-content form','inputDefaults'=>array('before'=>'<p>','after'=>'</p>'))); ?>
            ...
            <div class="block-actions">
                <ul class="actions-left">
                    <li><?php echo $this->Html->link(__('Lista de Áreas Funcionais'), array('controller' => 'area_unidades', 'action' => 'index'), array('class' => 'button red')) ?></li>
                </ul>
