<?php
App::uses('BolsaCandidatoFamiliasController', 'Controller');

/**
 * BolsaCandidatoFamiliasController Test Case
 *
 */
class BolsaCandidatoFamiliasControllerTest extends ControllerTestCase {
