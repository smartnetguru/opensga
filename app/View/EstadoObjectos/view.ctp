...
<div class="actions">
    ...
    <ul>
        <li><?php echo $this->Html->link(__('Edit Estado Objecto'),
                    ['action' => 'edit', $estadoObjecto['EstadoObjecto']['id']]); ?> </li>
        <li><?php echo $this->Form->postLink(__('Delete Estado Objecto'),
                    ['action' => 'delete', $estadoObjecto['EstadoObjecto']['id']], [],
                    __('Are you sure you want to delete # %s?', $estadoObjecto['EstadoObjecto']['id'])); ?> </li>
                ...
                <tr>
                    ...
                    <td class="actions">
                        <?php echo $this->Html->link(__('View'),
                                ['controller' => 'bolsa_pedidos', 'action' => 'view', $bolsaPedido['id']]); ?>
                        <?php echo $this->Html->link(__('Edit'),
                                ['controller' => 'bolsa_pedidos', 'action' => 'edit', $bolsaPedido['id']]); ?>
                        <?php echo $this->Form->postLink(__('Delete'),
                                ['controller' => 'bolsa_pedidos', 'action' => 'delete', $bolsaPedido['id']], [],
                                __('Are you sure you want to delete # %s?', $bolsaPedido['id'])); ?>
                    </td>
                </tr>
            <?php endforeach; ?>
        </table>
                ...
                <tr>
                    ...
                    <td class="actions">
                        ...
                        <?php echo $this->Form->postLink(__('Delete'), [
                                ...
                                'action'     => 'delete',
                                $candidatoGraduacao['id'],
                        ], [], __('Are you sure you want to delete # %s?', $candidatoGraduacao['id'])); ?>
                    </td>
                </tr>
            <?php endforeach; ?>
        </table>
        ...
        <table cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($estadoObjecto['CursoResponsavel'] as $cursoResponsavel): ?>
                <tr>
                    ...
                    <td class="actions">
                        <?php echo $this->Html->link(__('View'),
                                ['controller' => 'curso_responsavels', 'action' => 'view', $cursoResponsavel['id']]); ?>
                        <?php echo $this->Html->link(__('Edit'),
                                ['controller' => 'curso_responsavels', 'action' => 'edit', $cursoResponsavel['id']]); ?>
                        <?php echo $this->Form->postLink(__('Delete'),
                                ['controller' => 'curso_responsavels', 'action' => 'delete', $cursoResponsavel['id']],
                                [], __('Are you sure you want to delete # %s?', $cursoResponsavel['id'])); ?>
                    </td>
                </tr>
            <?php endforeach; ?>
        </table>
        ...
        <table cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($estadoObjecto['DisciplinaDocente'] as $disciplinaDocente): ?>
                <tr>
                    ...
                    <td class="actions">
                        <?php echo $this->Html->link(__('View'), [
                                'controller' => 'disciplina_docentes',
                                'action'     => 'view',
                                $disciplinaDocente['id'],
                        ]); ?>
                        <?php echo $this->Html->link(__('Edit'), [
                                'controller' => 'disciplina_docentes',
                                'action'     => 'edit',
                        ...
                        <?php echo $this->Form->postLink(__('Delete'),
                                ['controller' => 'disciplina_docentes', 'action' => 'delete', $disciplinaDocente['id']],
                                [], __('Are you sure you want to delete # %s?', $disciplinaDocente['id'])); ?>
                    </td>
                </tr>
            <?php endforeach; ?>
        </table>
        ...
        <table cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($estadoObjecto['DisciplinaPlanoEstudo'] as $disciplinaPlanoEstudo): ?>
                <tr>
                    ...
                    <td class="actions">
                        <?php echo $this->Html->link(__('View'), [
                                'controller' => 'disciplina_plano_estudos',
                                'action'     => 'view',
                                $disciplinaPlanoEstudo['id'],
                        ]); ?>
                        <?php echo $this->Html->link(__('Edit'), [
                                'controller' => 'disciplina_plano_estudos',
                                'action'     => 'edit',
                        ...
                        <?php echo $this->Form->postLink(__('Delete'), [
                                ...
                                'action'     => 'delete',
                                $disciplinaPlanoEstudo['id'],
                        ], [], __('Are you sure you want to delete # %s?', $disciplinaPlanoEstudo['id'])); ?>
                    </td>
                </tr>
            <?php endforeach; ?>
        </table>
        ...
        <table cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($estadoObjecto['DisciplinaUnidadeOrganica'] as $disciplinaUnidadeOrganica): ?>
                <tr>
                    ...
                    <td class="actions">
                        <?php echo $this->Html->link(__('View'), [
                                'controller' => 'disciplina_unidade_organicas',
                                'action'     => 'view',
                                $disciplinaUnidadeOrganica['id'],
                        ]); ?>
                        <?php echo $this->Html->link(__('Edit'), [
                                'controller' => 'disciplina_unidade_organicas',
                                'action'     => 'edit',
                        ...
                        <?php echo $this->Form->postLink(__('Delete'), [
                                ...
                                'action'     => 'delete',
                                $disciplinaUnidadeOrganica['id'],
                        ], [], __('Are you sure you want to delete # %s?', $disciplinaUnidadeOrganica['id'])); ?>
                    </td>
                </tr>
            <?php endforeach; ?>
        </table>
        ...
        <table cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($estadoObjecto['EntidadeContacto'] as $entidadeContacto): ?>
                <tr>
                    ...
                    <td class="actions">
                        <?php echo $this->Html->link(__('View'),
                                ['controller' => 'entidade_contactos', 'action' => 'view', $entidadeContacto['id']]); ?>
                        <?php echo $this->Html->link(__('Edit'),
                                ['controller' => 'entidade_contactos', 'action' => 'edit', $entidadeContacto['id']]); ?>
                        <?php echo $this->Form->postLink(__('Delete'),
                                ['controller' => 'entidade_contactos', 'action' => 'delete', $entidadeContacto['id']],
                                [], __('Are you sure you want to delete # %s?', $entidadeContacto['id'])); ?>
                    </td>
                </tr>
            <?php endforeach; ?>
        </table>
        ...
        <table cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($estadoObjecto['EntidadeIdentificacao'] as $entidadeIdentificacao): ?>
                <tr>
                    ...
                    <td class="actions">
                        <?php echo $this->Html->link(__('View'), [
                                'controller' => 'entidade_identificacaos',
                                'action'     => 'view',
                                $entidadeIdentificacao['id'],
                        ]); ?>
                        <?php echo $this->Html->link(__('Edit'), [
                                'controller' => 'entidade_identificacaos',
                                'action'     => 'edit',
                        ...
                        <?php echo $this->Form->postLink(__('Delete'), [
                                ...
                                'action'     => 'delete',
                                $entidadeIdentificacao['id'],
                        ], [], __('Are you sure you want to delete # %s?', $entidadeIdentificacao['id'])); ?>
                    </td>
                </tr>
            <?php endforeach; ?>
        </table>
        ...
        <table cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($estadoObjecto['FormaMudancaCurso'] as $formaMudancaCurso): ?>
                <tr>
                    ...
                    <td class="actions">
                        <?php echo $this->Html->link(__('View'), [
                                'controller' => 'forma_mudanca_cursos',
                                'action'     => 'view',
                                $formaMudancaCurso['id'],
                        ]); ?>
                        <?php echo $this->Html->link(__('Edit'), [
                                'controller' => 'forma_mudanca_cursos',
                                'action'     => 'edit',
                        ...
                        <?php echo $this->Form->postLink(__('Delete'), [
                                ...
                                'action'     => 'delete',
                                $formaMudancaCurso['id'],
                        ], [], __('Are you sure you want to delete # %s?', $formaMudancaCurso['id'])); ?>
                    </td>
                </tr>
            <?php endforeach; ?>
        </table>
        ...
        <table cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($estadoObjecto['FuncaoProfissionalRole'] as $funcaoProfissionalRole): ?>
                <tr>
                    ...
                    <td class="actions">
                        <?php echo $this->Html->link(__('View'), [
                                'controller' => 'funcao_profissional_roles',
                                'action'     => 'view',
                                $funcaoProfissionalRole['id'],
                        ]); ?>
                        <?php echo $this->Html->link(__('Edit'), [
                                'controller' => 'funcao_profissional_roles',
                                'action'     => 'edit',
                        ...
                        <?php echo $this->Form->postLink(__('Delete'), [
                                ...
                                'action'     => 'delete',
                                $funcaoProfissionalRole['id'],
                        ], [], __('Are you sure you want to delete # %s?', $funcaoProfissionalRole['id'])); ?>
                    </td>
                </tr>
            <?php endforeach; ?>
        </table>
        ...
        <table cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($estadoObjecto['GroupRole'] as $groupRole): ?>
                <tr>
                    ...
                    <td class="actions">
                        <?php echo $this->Html->link(__('View'),
                                ['controller' => 'group_roles', 'action' => 'view', $groupRole['id']]); ?>
                        <?php echo $this->Html->link(__('Edit'),
                                ['controller' => 'group_roles', 'action' => 'edit', $groupRole['id']]); ?>
                        <?php echo $this->Form->postLink(__('Delete'),
                                ['controller' => 'group_roles', 'action' => 'delete', $groupRole['id']], [],
                                __('Are you sure you want to delete # %s?', $groupRole['id'])); ?>
                    </td>
                </tr>
            <?php endforeach; ?>
        </table>
            ...
            <?php foreach ($estadoObjecto['Group'] as $group): ?>
                <tr>
                    ...
                    <td class="actions">
                        ...
                        <?php echo $this->Form->postLink(__('Delete'),
                                ['controller' => 'groups', 'action' => 'delete', $group['id']], [],
                                __('Are you sure you want to delete # %s?', $group['id'])); ?>
                    </td>
                </tr>
            <?php endforeach; ?>
        </table>
        ...
        <table cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($estadoObjecto['GroupsUser'] as $groupsUser): ?>
                <tr>
                    ...
                    <td class="actions">
                        <?php echo $this->Html->link(__('View'),
                                ['controller' => 'groups_users', 'action' => 'view', $groupsUser['id']]); ?>
                        <?php echo $this->Html->link(__('Edit'),
                                ['controller' => 'groups_users', 'action' => 'edit', $groupsUser['id']]); ?>
                        <?php echo $this->Form->postLink(__('Delete'),
                                ['controller' => 'groups_users', 'action' => 'delete', $groupsUser['id']], [],
                                __('Are you sure you want to delete # %s?', $groupsUser['id'])); ?>
                    </td>
                </tr>
            <?php endforeach; ?>
        </table>
            ...
            <?php foreach ($estadoObjecto['Message'] as $message): ?>
                <tr>
                    ...
                    <td class="actions">
                        ...
                        <?php echo $this->Html->link(__('Edit'),
                                ['controller' => 'messages', 'action' => 'edit', $message['id']]); ?>
                        <?php echo $this->Form->postLink(__('Delete'),
                                ['controller' => 'messages', 'action' => 'delete', $message['id']], [],
                                __('Are you sure you want to delete # %s?', $message['id'])); ?>
                    </td>
                </tr>
            <?php endforeach; ?>
        </table>
    ...
    <div class="actions">
        <ul>
            <li><?php echo $this->Html->link(__('New Message'),
                        ['controller' => 'messages', 'action' => 'add']); ?> </li>
        </ul>
    </div>
</div>
<div class="related">
        ...
        <table cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($estadoObjecto['PlanoEstudo'] as $planoEstudo): ?>
                <tr>
                    ...
                    <td class="actions">
                        <?php echo $this->Html->link(__('View'),
                                ['controller' => 'plano_estudos', 'action' => 'view', $planoEstudo['id']]); ?>
                        <?php echo $this->Html->link(__('Edit'),
                                ['controller' => 'plano_estudos', 'action' => 'edit', $planoEstudo['id']]); ?>
                        <?php echo $this->Form->postLink(__('Delete'),
                                ['controller' => 'plano_estudos', 'action' => 'delete', $planoEstudo['id']], [],
                                __('Are you sure you want to delete # %s?', $planoEstudo['id'])); ?>
                    </td>
                </tr>
            <?php endforeach; ?>
        </table>
        ...
        <table cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($estadoObjecto['Precedencia'] as $precedencia): ?>
                <tr>
                    ...
                    <td class="actions">
                        <?php echo $this->Html->link(__('View'),
                                ['controller' => 'precedencias', 'action' => 'view', $precedencia['id']]); ?>
                        <?php echo $this->Html->link(__('Edit'),
                                ['controller' => 'precedencias', 'action' => 'edit', $precedencia['id']]); ?>
                        <?php echo $this->Form->postLink(__('Delete'),
                                ['controller' => 'precedencias', 'action' => 'delete', $precedencia['id']], [],
                                __('Are you sure you want to delete # %s?', $precedencia['id'])); ?>
                    </td>
                </tr>
            <?php endforeach; ?>
        </table>
                ...
                <tr>
                    ...
                    <td class="actions">
                        ...
                        <?php echo $this->Form->postLink(__('Delete'),
                                ...
                                __('Are you sure you want to delete # %s?', $role['id'])); ?>
                    </td>
                </tr>
            <?php endforeach; ?>
        </table>
        ...
        <table cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($estadoObjecto['UnidadeOrganicaRole'] as $unidadeOrganicaRole): ?>
                <tr>
                    ...
                    <td class="actions">
                        <?php echo $this->Html->link(__('View'), [
                                'controller' => 'unidade_organica_roles',
                                'action'     => 'view',
                                $unidadeOrganicaRole['id'],
                        ]); ?>
                        <?php echo $this->Html->link(__('Edit'), [
                                'controller' => 'unidade_organica_roles',
                                'action'     => 'edit',
                        ...
                        <?php echo $this->Form->postLink(__('Delete'), [
                                ...
                                'action'     => 'delete',
                                $unidadeOrganicaRole['id'],
                        ], [], __('Are you sure you want to delete # %s?', $unidadeOrganicaRole['id'])); ?>
                    </td>
                </tr>
            <?php endforeach; ?>
        </table>
        ...
        <table cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($estadoObjecto['UnidadeOrganica'] as $unidadeOrganica): ?>
                <tr>
                    ...
                    <td class="actions">
                        <?php echo $this->Html->link(__('View'),
                                ['controller' => 'unidade_organicas', 'action' => 'view', $unidadeOrganica['id']]); ?>
                        <?php echo $this->Html->link(__('Edit'),
                                ['controller' => 'unidade_organicas', 'action' => 'edit', $unidadeOrganica['id']]); ?>
                        <?php echo $this->Form->postLink(__('Delete'),
                                ['controller' => 'unidade_organicas', 'action' => 'delete', $unidadeOrganica['id']], [],
                                __('Are you sure you want to delete # %s?', $unidadeOrganica['id'])); ?>
                    </td>
                </tr>
            <?php endforeach; ?>
        </table>
        ...
        <table cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($estadoObjecto['UserRole'] as $userRole): ?>
                <tr>
                    ...
                    <td class="actions">
                        <?php echo $this->Html->link(__('View'),
                                ['controller' => 'user_roles', 'action' => 'view', $userRole['id']]); ?>
                        <?php echo $this->Html->link(__('Edit'),
                                ['controller' => 'user_roles', 'action' => 'edit', $userRole['id']]); ?>
                        <?php echo $this->Form->postLink(__('Delete'),
                                ['controller' => 'user_roles', 'action' => 'delete', $userRole['id']], [],
                                __('Are you sure you want to delete # %s?', $userRole['id'])); ?>
                    </td>
                </tr>
            <?php endforeach; ?>
        </table>
