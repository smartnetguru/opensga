...
//die(debug($aluno));
    ...
    while($totalPaginas>=$paginaActual) {
        ...
        if ($paginaActual != 1) {
            $this->PhpExcel->xls->getActiveSheet()->mergeCells('A' . $linha_actual . ':E' . $linha_actual);
            $this->PhpExcel->xls->getActiveSheet()->duplicateStyle($this->PhpExcel->xls->getActiveSheet()->getStyle('A2'), 'A' . $linha_actual);
            $this->PhpExcel->xls->getActiveSheet()->getStyle('A' . $linha_actual . ':E' . $linha_actual)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
            $this->PhpExcel->xls->getActiveSheet()->getStyle('A' . $linha_actual . ':E' . $linha_actual)->getAlignment()->setVertical(PHPExcel_Style_Alignment::VERTICAL_CENTER);
        }
        $linha_actual++;
        ...
        if ($paginaActual != 1) {
            $this->PhpExcel->xls->getActiveSheet()->mergeCells('A' . $linha_actual . ':E' . $linha_actual);
            $this->PhpExcel->xls->getActiveSheet()->duplicateStyle($this->PhpExcel->xls->getActiveSheet()->getStyle('A3'), 'A' . $linha_actual);
            $this->PhpExcel->xls->getActiveSheet()->getStyle('A' . $linha_actual . ':E' . $linha_actual)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
            $this->PhpExcel->xls->getActiveSheet()->getStyle('A' . $linha_actual . ':E' . $linha_actual)->getAlignment()->setVertical(PHPExcel_Style_Alignment::VERTICAL_CENTER);
        }
        $linha_actual++;
        ...
        if ($paginaActual != 1) {
            $this->PhpExcel->xls->getActiveSheet()->mergeCells('A' . $linha_actual . ':E' . $linha_actual);
            $this->PhpExcel->xls->getActiveSheet()->duplicateStyle($this->PhpExcel->xls->getActiveSheet()->getStyle('A4'), 'A' . $linha_actual);
            $this->PhpExcel->xls->getActiveSheet()->getStyle('A' . $linha_actual . ':E' . $linha_actual)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
            $this->PhpExcel->xls->getActiveSheet()->getStyle('A' . $linha_actual . ':E' . $linha_actual)->getAlignment()->setVertical(PHPExcel_Style_Alignment::VERTICAL_CENTER);
        }
        $linha_actual++;
        ...
        if ($paginaActual != 1) {
            $this->PhpExcel->xls->getActiveSheet()->mergeCells('A' . $linha_actual . ':E' . $linha_actual);
            $this->PhpExcel->xls->getActiveSheet()->duplicateStyle($this->PhpExcel->xls->getActiveSheet()->getStyle('A6'), 'A' . $linha_actual);
            $this->PhpExcel->xls->getActiveSheet()->getStyle('A' . $linha_actual . ':E' . $linha_actual)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
            $this->PhpExcel->xls->getActiveSheet()->getStyle('A' . $linha_actual . ':E' . $linha_actual)->getAlignment()->setVertical(PHPExcel_Style_Alignment::VERTICAL_CENTER);
        }
        $linha_actual++;
        ...
        if ($paginaActual != 1) {
            ...
            $this->PhpExcel->xls->getActiveSheet()->duplicateStyle($this->PhpExcel->xls->getActiveSheet()->getStyle('A8'), 'A' . $linha_actual);
            $this->PhpExcel->xls->getActiveSheet()->getStyle('A' . $linha_actual . ':E' . $linha_actual)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
            $this->PhpExcel->xls->getActiveSheet()->getStyle('A' . $linha_actual . ':E' . $linha_actual)->getAlignment()->setVertical(PHPExcel_Style_Alignment::VERTICAL_CENTER);
        }
$linha_actual++;
