                ...
                <tr>
                    ...
                    <td>
                        <?php echo $this->Html->link($faculdadeTipoPagamento['Faculdade']['name'], [
                                ...
                                'action'     => 'view',
                                $faculdadeTipoPagamento['Faculdade']['id'],
                        ]); ?>
                    </td>
                    <td>
                    ...
                    <td class="actions">
                        <?php echo $this->Html->link(__('View'),
                                ['action' => 'view', $faculdadeTipoPagamento['FaculdadeTipoPagamento']['id']]); ?>
                        <?php echo $this->Html->link(__('Edit'),
                                ['action' => 'edit', $faculdadeTipoPagamento['FaculdadeTipoPagamento']['id']]); ?>
                        <?php echo $this->Form->postLink(__('Delete'),
                                ['action' => 'delete', $faculdadeTipoPagamento['FaculdadeTipoPagamento']['id']], null,
                                __('Are you sure you want to delete # %s?',
                                        $faculdadeTipoPagamento['FaculdadeTipoPagamento']['id'])); ?>
                    </td>
                </tr>
            <?php endforeach; ?>
    </table>
