...
<div class="projectos index" id="center-column">
    <div class="top-bar">
        <?php echo $this->Html->link(sprintf(__('Nova Cidade', true)), ['action' => 'add'], ['class' => 'button']); ?>
            ...
            <?php
                ...
                foreach ($cidades as $cidade):
                    ...
                    <tr<?php echo $class; ?>>
                        ...
                        <td>
                            <?php echo $this->Html->link($cidade['Provincia']['name'],
                                    ['controller' => 'Provincias', 'action' => 'view', $cidade['Provincia']['id']]); ?>
                        </td>
                        <td>
                            <?php echo $this->Html->link($cidade['Paise']['name'],
                                    ['controller' => 'Paises', 'action' => 'view', $cidade['Paise']['id']]); ?>
                        </td>
                        <td class="accoes">
                            <?php echo $this->Html->image("/img/login-icon.gif", [
                                    "alt"   => "Brownies",
                                    "title" => "Visualizar",
                                    'url'   => ['action' => 'view', $cidade['Cidade']['id']],
                            ]); ?>
                            <?php echo $this->Html->image("/img/edit-icon.gif", [
                                    "alt"   => "Brownies",
                                    "title" => "Editar",
                                    'url'   => ['action' => 'edit', $cidade['Cidade']['id']],
                            ]); ?>
                            <?php echo $this->Html->image("/img/hr.gif", [
                                    "alt"   => "Brownies",
                                    "title" => "Eliminar",
                                    'url'   => ['action' => 'delete', $cidade['Cidade']['id']],
                                    null,
