...
<div class="action-list">
	<div class="col-sm-1">
		<?php echo $this->Html->link('<i class="fa fa-user fa-2x"></i>Enviar SMS em Massa',
            array('controller' => 'messages', 'action' => 'send_mass_sms'), array('escape' => false,
...
<?php echo $this->Form->create('SMSNotification', array('role' => 'form', 'enctype' => 'multipart/form-data',
