<div class="docenteDisciplinas index">
	...
	<tr>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $docenteDisciplina['DocenteDisciplina']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $docenteDisciplina['DocenteDisciplina']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $docenteDisciplina['DocenteDisciplina']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $docenteDisciplina['DocenteDisciplina']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
