        ...
        <?php
            ...
            foreach ($months as $month): ?>
                <tr>
                    ...
                    <td class="actions">
                        <?php echo $this->Html->link(__('View'), ['action' => 'view', $month['Month']['id']]); ?>
                        <?php echo $this->Html->link(__('Edit'), ['action' => 'edit', $month['Month']['id']]); ?>
                        <?php echo $this->Form->postLink(__('Delete'), ['action' => 'delete', $month['Month']['id']],
                                null, __('Are you sure you want to delete # %s?', $month['Month']['id'])); ?>
                    </td>
                </tr>
            <?php endforeach; ?>
    </table>
