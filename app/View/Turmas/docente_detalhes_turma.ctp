...
$this->Html->addCrumb($turma['Turma']['name'], '/turmas/view/'.$turma['Turma']['id']);
 ?>
				...
				<div class="block-border">
					<div class="block-content">
						<ul class="shortcut-list">
                            <li>
								<?php echo $this->Html->link($this->Html->image('icons/packs/crystal/48x48/apps/printer.png')."Imprimir Lista de Estudantes",array('controller'=>'turmas','action'=>'lista_estudantes',$turma['Turma']['id']),array('escape'=>false)) ?>
							</li>
                            <li>
								<?php echo $this->Html->link($this->Html->image('icons/packs/crystal/48x48/apps/printer.png')."Criar Nova Avaliação",array('controller'=>'TurmaTipoAvaliacaos','action'=>'add',$turma['Turma']['id']),array('escape'=>false)) ?>

							</li>
                            <li>
								<?php echo $this->Form->postLink($this->Html->image('icons/packs/crystal/48x48/apps/printer.png')."Solicitar Fecho da Turma",array('controller'=>'turmas','action'=>'fechar_turma',$turma['Turma']['id']),array('escape'=>false)) ?>
	...
	?>
	<tr<?php echo $class;?>>
		<td><?php echo $this->Html->link($TurmaTipoAvaliacao['TipoAvaliacao']['name']."  #".$TurmaTipoAvaliacao['TurmaTipoAvaliacao']['ordem'],array('controller'=>'TurmaTipoAvaliacaos','action'=>'view',$TurmaTipoAvaliacao['TurmaTipoAvaliacao']['id'])); ?>&nbsp;</td>
...
<?php endforeach; ?>
	...
	<tr<?php echo $class;?>>
        <td><?php echo $i;?></td>
		<td><?php echo $inscricao['Matricula']['Aluno']['codigo']; ?>&nbsp;</td>
        <td><?php echo $inscricao['Matricula']['Aluno']['Entidade']['apelido']; ?>&nbsp;</td>
		<td><?php echo $inscricao['Matricula']['Aluno']['Entidade']['name']; ?>&nbsp;</td>
