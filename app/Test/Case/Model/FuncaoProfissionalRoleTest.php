<?php
App::uses('FuncaoProfissionalRole', 'Model');

/**
 * FuncaoProfissionalRole Test Case
 *
 */
class FuncaoProfissionalRoleTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->FuncaoProfissionalRole = ClassRegistry::init('FuncaoProfissionalRole');
	}
 ...
 */
	public function tearDown() {
		unset($this->FuncaoProfissionalRole);
