 ...
 */
	public function view($id = null) {
		...
		$options = array('conditions' => array('CooperacaoAcordoUnidadeOrganica.' . $this->CooperacaoAcordoUnidadeOrganica->primaryKey => $id));
		$this->set('cooperacaoAcordoUnidadeOrganica', $this->CooperacaoAcordoUnidadeOrganica->find('first', $options));
	}
