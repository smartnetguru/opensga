...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Estado Docente Turma'), array('action' => 'edit', $estadoDocenteTurma['EstadoDocenteTurma']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Estado Docente Turma'), array('action' => 'delete', $estadoDocenteTurma['EstadoDocenteTurma']['id']), array(), __('Are you sure you want to delete # %s?', $estadoDocenteTurma['EstadoDocenteTurma']['id'])); ?> </li>
...
<div class="related">
	...
	<?php foreach ($estadoDocenteTurma['DocenteTurma'] as $docenteTurma): ?>
		<tr>
			...
			<td class="actions">
				<?php echo $this->Html->link(__('View'), array('controller' => 'docente_turmas', 'action' => 'view', $docenteTurma['id'])); ?>
				<?php echo $this->Html->link(__('Edit'), array('controller' => 'docente_turmas', 'action' => 'edit', $docenteTurma['id'])); ?>
				<?php echo $this->Form->postLink(__('Delete'), array('controller' => 'docente_turmas', 'action' => 'delete', $docenteTurma['id']), array(), __('Are you sure you want to delete # %s?', $docenteTurma['id'])); ?>
			</td>
		</tr>
	<?php endforeach; ?>
	</table>
