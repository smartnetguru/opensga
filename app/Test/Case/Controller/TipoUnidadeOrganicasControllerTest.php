<?php
App::uses('TipoUnidadeOrganicasController', 'Controller');

/**
 * TipoUnidadeOrganicasController Test Case
 *
 */
class TipoUnidadeOrganicasControllerTest extends ControllerTestCase {
