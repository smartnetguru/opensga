<div class="planoestudoanos index">
	...
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View', true), array('action' => 'view', $planoestudoano['DisciplinaPlanoEstudo']['id'])); ?>
			<?php echo $this->Html->link(__('Edit', true), array('action' => 'edit', $planoestudoano['DisciplinaPlanoEstudo']['id'])); ?>
			<?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $planoestudoano['DisciplinaPlanoEstudo']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $planoestudoano['DisciplinaPlanoEstudo']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(sprintf(__('New %s', true), __('DisciplinaPlanoEstudo', true)), array('action' => 'add')); ?></li>
	</ul>
</div>