...
<div class="actions">
    ...
    <ul>
        <li><?php echo $this->Html->link(__('Edit Bolsa Fonte Bolsa'),
                    ['action' => 'edit', $bolsaFonteBolsa['BolsaFonteBolsa']['id']]); ?> </li>
        <li><?php echo $this->Form->postLink(__('Delete Bolsa Fonte Bolsa'),
                    ['action' => 'delete', $bolsaFonteBolsa['BolsaFonteBolsa']['id']], null,
                    __('Are you sure you want to delete # %s?', $bolsaFonteBolsa['BolsaFonteBolsa']['id'])); ?> </li>
