        ...
        foreach ($funcionarios as $funcionario) {
            ...
            if ($this->User->isFromFaculdade($funcionario['User']['id'])) {
                ...
                if (in_array('DRA', $unidadesOrganicas)) {
                    ...
                    $comandos[] = "acl grant User.{$funcionario['User']['id']} controllers/DatabaseLog/Logs/admin_index";
                    ...
                    $comandos[] = "acl grant User.{$funcionario['User']['id']} controllers/PlanoEstudos/ver_plano_estudos";
