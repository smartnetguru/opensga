...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Financeiro Tipo Transacao'), array('action' => 'edit', $financeiroTipoTransacao['FinanceiroTipoTransacao']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Financeiro Tipo Transacao'), array('action' => 'delete', $financeiroTipoTransacao['FinanceiroTipoTransacao']['id']), null, __('Are you sure you want to delete # %s?', $financeiroTipoTransacao['FinanceiroTipoTransacao']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('List Financeiro Tipo Transacaos'), array('action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(__('New Financeiro Tipo Transacao'), array('action' => 'add')); ?> </li>
...
<div class="related">
	...
	<?php
		...
		<tr>
			...
			<td class="actions">
				<?php echo $this->Html->link(__('View'), array('controller' => 'financeiro_transacaos', 'action' => 'view', $financeiroTransacao['id'])); ?>
				<?php echo $this->Html->link(__('Edit'), array('controller' => 'financeiro_transacaos', 'action' => 'edit', $financeiroTransacao['id'])); ?>
				<?php echo $this->Form->postLink(__('Delete'), array('controller' => 'financeiro_transacaos', 'action' => 'delete', $financeiroTransacao['id']), null, __('Are you sure you want to delete # %s?', $financeiroTransacao['id'])); ?>
			</td>
		</tr>
	<?php endforeach; ?>
	</table>
