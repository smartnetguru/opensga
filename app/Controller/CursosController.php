    ...
    class CursosController extends AppController
    {
        ...
        function adicionar_curso()
        {
            ...
            if (!empty($this->data)) {
                ...
                $this->Curso->create();
                if ($this->Curso->cadastraCurso($this->data)) {
                    $this->Session->setFlash(__('Curso Cadastrado com Sucesso'), 'default',
                        ['class' => 'alert success']);

                    $this->redirect(['action' => 'index']);
                } else {
                    $this->Session->setFlash(__('Erro ao Cadastrar Curso. Por favor tente de novo'), 'default',
                        ['class' => 'alert error']);
                }
            }
        ...
        public function definir_encarregado($cursoId)
        {
            ...
            if ($this->request->is('post')) {
                if ($this->Curso->setResponsavelCurso($this->request->data)) {
                    ...
                    $this->redirect(['action' => 'ver_curso', $cursoId]);
                } else {
        ...
        public function manutencao()
        {
            ...
            $cursosSemEncarregado = $this->Curso->find('count',
                ['conditions' => ['Curso.user_responsavel_curso is null']]);
        ...
        public function definir_estado_curso($cursoId = null)
        {
            ...
            if ($this->request->is('post')) {
                ...
                $this->redirect([
                    'controller' => 'cursos',
                    'action'     => 'ver_curso',
                    $this->request->data['Curso']['curso_id'],
                ]);
