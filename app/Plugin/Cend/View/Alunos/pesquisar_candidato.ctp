...
<div class="action-list">
    <div class="col-sm-2">
        <?php echo $this->Html->link('<br/><i class="fa fa-plus"></i>	Novo Estudante', ['controller' => 'alunos', 'action' => 'adicionar_estudante'], ['escape' => false, 'class' => 'btn btn-icon btn-block']) ?>
    </div>
    <div class="col-sm-2">
        <?php echo $this->Html->link('<br/><i class="fa fa-plus"></i>	Imprimir Despacho', ['controller' => 'alunos', 'action' => 'print_bolsas_novo_ingresso'], ['escape' => false, 'class' => 'btn btn-icon btn-block']) ?>
    </div>
    <div class="col-sm-2">
        <?php echo $this->Html->link('<br/><i class="fa fa-bar-chart"></i>	Exportar Bolseiros', ['controller' => 'bolsa_bolsas', 'action' => 'exportar_bolseiros_ano_ingresso'], ['escape' => false, 'class' => 'btn btn-icon btn-block']) ?>
    </div>
    <div class="col-sm-2">
        <?php echo $this->Html->link('<br/><i class="fa fa-bar-chart"></i>	Exportar Bolseiros das Escolas', ['controller' => 'bolsa_bolsas', 'action' => 'exportar_bolseiros_ano_ingresso_escolas'], ['escape' => false, 'class' => 'btn btn-icon btn-block']) ?>
    </div>
    <div class="col-sm-2">
        <?php echo $this->Html->link('<br/><i class="fa fa-bar-chart"></i>	Exportar Estudantes Bolseiros', ['controller' => 'alunos', 'action' => 'exportar_estudantes_bolseiros'], ['escape' => false, 'class' => 'btn btn-icon btn-block']) ?>
    </div>
