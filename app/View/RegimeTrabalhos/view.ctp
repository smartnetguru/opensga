...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Regime Trabalho'), array('action' => 'edit', $regimeTrabalho['RegimeTrabalho']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Regime Trabalho'), array('action' => 'delete', $regimeTrabalho['RegimeTrabalho']['id']), null, __('Are you sure you want to delete # %s?', $regimeTrabalho['RegimeTrabalho']['id'])); ?> </li>
