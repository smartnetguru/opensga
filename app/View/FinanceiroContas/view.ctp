...
<h2><?php  echo __('Financeiro Conta'); ?></h2>
	<dl>
		...
		<dd>
			<?php echo $this->Html->link($financeiroConta['Entidade']['name'], array('controller' => 'entidades', 'action' => 'view', $financeiroConta['Entidade']['id'])); ?>
			&nbsp;
		</dd>
...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Financeiro Conta'), array('action' => 'edit', $financeiroConta['FinanceiroConta']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Financeiro Conta'), array('action' => 'delete', $financeiroConta['FinanceiroConta']['id']), null, __('Are you sure you want to delete # %s?', $financeiroConta['FinanceiroConta']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('List Financeiro Contas'), array('action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(__('New Financeiro Conta'), array('action' => 'add')); ?> </li>
