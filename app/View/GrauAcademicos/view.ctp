...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Grau Academico'), array('action' => 'edit', $grauAcademico['GrauAcademico']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Grau Academico'), array('action' => 'delete', $grauAcademico['GrauAcademico']['id']), array(), __('Are you sure you want to delete # %s?', $grauAcademico['GrauAcademico']['id'])); ?> </li>
...
<div class="related">
	...
	<?php foreach ($grauAcademico['AlumniCandidatoAlumni'] as $candidatoAlumni): ?>
		<tr>
			...
			<td class="actions">
				<?php echo $this->Html->link(__('View'), array('controller' => 'candidato_alumnis', 'action' => 'view', $candidatoAlumni['id'])); ?>
				<?php echo $this->Html->link(__('Edit'), array('controller' => 'candidato_alumnis', 'action' => 'edit', $candidatoAlumni['id'])); ?>
				<?php echo $this->Form->postLink(__('Delete'), array('controller' => 'candidato_alumnis', 'action' => 'delete', $candidatoAlumni['id']), array(), __('Are you sure you want to delete # %s?', $candidatoAlumni['id'])); ?>
			</td>
		</tr>
	<?php endforeach; ?>
	</table>
