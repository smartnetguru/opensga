        ...
        <div class="block-border">
            <div class="block-content">
                <ul class="shortcut-list">
                    ...
                    <li>
                        <?php //echo $this->Html->link($this->Html->image('icons/packs/crystal/48x48/apps/kedit.png') . __("Definir Director"), array('controller' => 'unidade_organicas', 'action' => 'definir_director_faculdade',$unidadeOrganica['UnidadeOrganica']['id']), array('escape' => false)) ?>
                    </li>
                </ul>
                <div class="clear"></div>
            </div>
