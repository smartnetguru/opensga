...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Financeiro Forma Deposito'), array('action' => 'edit', $financeiroFormaDeposito['FinanceiroFormaDeposito']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Financeiro Forma Deposito'), array('action' => 'delete', $financeiroFormaDeposito['FinanceiroFormaDeposito']['id']), null, __('Are you sure you want to delete # %s?', $financeiroFormaDeposito['FinanceiroFormaDeposito']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('List Financeiro Forma Depositos'), array('action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(__('New Financeiro Forma Deposito'), array('action' => 'add')); ?> </li>
