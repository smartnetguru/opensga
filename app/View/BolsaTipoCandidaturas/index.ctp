                ...
                <tr>
                    ...
                    <td class="actions">
                        <?php echo $this->Html->link(__('View'),
                                ['action' => 'view', $bolsaTipoCandidatura['BolsaTipoCandidatura']['id']]); ?>
                        <?php echo $this->Html->link(__('Edit'),
                                ['action' => 'edit', $bolsaTipoCandidatura['BolsaTipoCandidatura']['id']]); ?>
                        <?php echo $this->Form->postLink(__('Delete'),
                                ['action' => 'delete', $bolsaTipoCandidatura['BolsaTipoCandidatura']['id']], null,
                                __('Are you sure you want to delete # %s?',
                                        $bolsaTipoCandidatura['BolsaTipoCandidatura']['id'])); ?>
                    </td>
                </tr>
            <?php endforeach; ?>
    </table>
