<?php
App::uses('RegaliaSocial', 'Model');

/**
 * RegaliaSocial Test Case
 *
 */
class RegaliaSocialTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->RegaliaSocial = ClassRegistry::init('RegaliaSocial');
	}
