...
$this->Html->addCrumb('Lista de Tipos de Acordos de Cooperação', '/cooperacao/cooperacao_tipo_acordos');
...
<div id="container12" class="container_12">
        ...
        <div class="block-border">
            <div class="block-content">
                <ul class="shortcut-list">
                    ...
                    <li>
                        <a style="width: 160px;" href="#cooperacaoArea" data-toggle="modal" class="demo btn btn-default"> <?php echo $this->Html->image('icons/cooperacao/area_cooperacao.png', array('id' => 'imgEdit')) ?><span class="label label-info">Novo Tipo de Acordo</span></a>
    ...
    <div class="grid_12">
        <div class="block-border">
            ...
            <h2><?php echo __('Tipos de Acordos de Cooperação') ?>  <small class="text-danger" style="font-size: 15px;"><i class="fa fa-info-circle"></i>    Clique na linha do tipo de cooperação que deseja para poder editar.</small></h2>
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered table-hover table-full-width " id="sample_1">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $count = 0;
                                            foreach ($cooperacaoTipoAcordos as $cooperacaoTipoAcordo):

                                                $count++;
                                                ?>

                                                <tr  data-html="true" data-original-title=" Editar Tipo de acordo de Cooperação" data-content="
                                                     <form  method='post'  action='<?php echo $this->Html->url(array('controller' => 'CooperacaoTipoAcordos', 'action' => 'edit')); ?>'>
                                                     
                                                        <input type='text' class='form-control' id='name' name='name'  required='true' placeholder='<?php echo h($cooperacaoTipoAcordo['CooperacaoTipoAcordo']['name']); ?>'>
                                                        <input type='hidden' class='form-control' name='id' value='<?php echo h($cooperacaoTipoAcordo['CooperacaoTipoAcordo']['id']); ?>'>
                                                      <legend></legend>
                                                      <div class='pull-six'>
							...
							Alterar
                                                    ...
                                                    <td ><?php echo h($cooperacaoTipoAcordo['CooperacaoTipoAcordo']['name']); ?></td>
...
<div id="cooperacaoArea" class="modal fade" tabindex="-1" data-width="500" style="display: none;">
    <div class="modal-header">
        ...
        <h4 class="modal-title">Adicionar Tipo de Acordos de Cooperação</h4>
    </div>
    <?php echo $this->Form->create(null, array('url' => array('controller' => 'CooperacaoTipoAcordos', 'action' => 'novo_tipo_acordo'), 'class' => "form", 'id' => 'form_viaAjaxArea', 'enctype' => 'multipart/form-data')); ?>

    <div class="modal-body">
        <div class="row">
            <div class="col-md-12">

                <?php echo $this->Form->input('name', array('label' => false, 'div' => false, 'class' => 'form-control autosize ', 'placeholder' => 'Nome do Tipo de  de Cooperação ', 'required','type' => 'text')); ?>
