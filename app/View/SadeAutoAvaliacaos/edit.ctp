...
<?php echo $this->Form->create('SadeAutoAvaliacao');?>
	<fieldset>
		<legend><?php echo __('Edit Sade Auto Avaliacao'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('SadeAutoAvaliacao.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('SadeAutoAvaliacao.id'))); ?></li>
