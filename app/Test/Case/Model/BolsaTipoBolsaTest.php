<?php
App::uses('BolsaTipoBolsa', 'Model');

/**
 * BolsaTipoBolsa Test Case
 *
 */
class BolsaTipoBolsaTestCase extends CakeTestCase {
/**
 * Fixtures
 *
 * @var array
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->BolsaTipoBolsa = ClassRegistry::init('BolsaTipoBolsa');
	}
