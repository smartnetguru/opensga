...
<h2><?php  echo __('Financeiro Transacao'); ?></h2>
	<dl>
		...
		<dd>
			<?php echo $this->Html->link($financeiroTransacao['FinanceiroTipoTransacao']['name'], array('controller' => 'financeiro_tipo_transacaos', 'action' => 'view', $financeiroTransacao['FinanceiroTipoTransacao']['id'])); ?>
			&nbsp;
		</dd>
		...
		<dd>
			<?php echo $this->Html->link($financeiroTransacao['Entidade']['name'], array('controller' => 'entidades', 'action' => 'view', $financeiroTransacao['Entidade']['id'])); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Financeiro Conta'); ?></dt>
		<dd>
			<?php echo $this->Html->link($financeiroTransacao['FinanceiroConta']['id'], array('controller' => 'financeiro_contas', 'action' => 'view', $financeiroTransacao['FinanceiroConta']['id'])); ?>
			&nbsp;
		</dd>
...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Financeiro Transacao'), array('action' => 'edit', $financeiroTransacao['FinanceiroTransacao']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Financeiro Transacao'), array('action' => 'delete', $financeiroTransacao['FinanceiroTransacao']['id']), null, __('Are you sure you want to delete # %s?', $financeiroTransacao['FinanceiroTransacao']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('List Financeiro Transacaos'), array('action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(__('New Financeiro Transacao'), array('action' => 'add')); ?> </li>
	...
	<?php
		...
		<tr>
			...
			<td class="actions">
				...
				<?php echo $this->Form->postLink(__('Delete'), array('controller' => 'financeiro_depositos', 'action' => 'delete', $financeiroDeposito['id']), null, __('Are you sure you want to delete # %s?', $financeiroDeposito['id'])); ?>
			</td>
		</tr>
	<?php endforeach; ?>
	</table>
