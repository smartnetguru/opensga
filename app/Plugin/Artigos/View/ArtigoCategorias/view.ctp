...
<div class="actions">
    ...
    <ul>
        <li><?php echo $this->Html->link(__('Edit Artigo Categoria'),
                    ['action' => 'edit', $artigoCategoria['ArtigoCategoria']['id']]); ?> </li>
        <li><?php echo $this->Form->postLink(__('Delete Artigo Categoria'),
                ...
                <tr>
                    ...
                    <td class="actions">
                        <?php echo $this->Html->link(__('View'), [
                                'controller' => 'artigo_categoria_artigos',
                                'action'     => 'view',
                                $artigoCategoriaArtigo['id'],
                        ]); ?>
                        ...
                        <?php echo $this->Form->postLink(__('Delete'), [
                                ...
                                'action'     => 'delete',
                                $artigoCategoriaArtigo['id'],
                        ], ['confirm' => __('Are you sure you want to delete # %s?', $artigoCategoriaArtigo['id'])]); ?>
                    </td>
                </tr>
            <?php endforeach; ?>
        </table>
