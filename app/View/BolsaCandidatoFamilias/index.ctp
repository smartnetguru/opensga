        ...
        <?php
            foreach ($bolsaCandidatoFamilias as $bolsaCandidatoFamilia): ?>
                <tr>
                    ...
                    <td><?php echo h($bolsaCandidatoFamilia['BolsaCandidatoFamilia']['curso_instituicao']); ?>
                        &nbsp;</td>
                    <td><?php echo h($bolsaCandidatoFamilia['BolsaCandidatoFamilia']['rendimento_mensal']); ?>
                        &nbsp;</td>
                    <td>
                    ...
                    <td class="actions">
                        <?php echo $this->Html->link(__('View'),
                                ['action' => 'view', $bolsaCandidatoFamilia['BolsaCandidatoFamilia']['id']]); ?>
                        <?php echo $this->Html->link(__('Edit'),
                                ['action' => 'edit', $bolsaCandidatoFamilia['BolsaCandidatoFamilia']['id']]); ?>
                        <?php echo $this->Form->postLink(__('Delete'),
                                ['action' => 'delete', $bolsaCandidatoFamilia['BolsaCandidatoFamilia']['id']], null,
                                __('Are you sure you want to delete # %s?',
                                        $bolsaCandidatoFamilia['BolsaCandidatoFamilia']['id'])); ?>
                    </td>
                </tr>
            <?php endforeach; ?>
    </table>
