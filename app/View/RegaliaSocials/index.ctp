<div class="regaliaSocials index">
	...
	<tr>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $regaliaSocial['RegaliaSocial']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $regaliaSocial['RegaliaSocial']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $regaliaSocial['RegaliaSocial']['id']), null, __('Are you sure you want to delete # %s?', $regaliaSocial['RegaliaSocial']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
