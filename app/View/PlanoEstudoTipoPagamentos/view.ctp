...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Plano Estudo Tipo Pagamento'), array('action' => 'edit', $planoEstudoTipoPagamento['PlanoEstudoTipoPagamento']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Plano Estudo Tipo Pagamento'), array('action' => 'delete', $planoEstudoTipoPagamento['PlanoEstudoTipoPagamento']['id']), null, __('Are you sure you want to delete # %s?', $planoEstudoTipoPagamento['PlanoEstudoTipoPagamento']['id'])); ?> </li>
