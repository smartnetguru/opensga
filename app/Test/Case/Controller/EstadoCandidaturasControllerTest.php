<?php
App::uses('EstadoCandidaturasController', 'Controller');

/**
 * EstadoCandidaturasController Test Case
 *
 */
class EstadoCandidaturasControllerTest extends ControllerTestCase {
