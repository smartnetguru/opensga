                ...
                <div class="tab-pane in active" id="panel_overview">
                    <div class="row">
                        <div class="col-sm-5 col-md-4">
                            <div class="user-left">
                                <div class="center">
                                    <h4><?php echo h($funcionario['Entidade']['name']); ?></h4>
                                    <?php

                                        $file = '/Fotos/Funcionarios/' . $funcionario['Entidade']['nuit'] . '.jpg';
                                    ...
                                    <?php
                                        ...
                                        echo '<h4>' . $funcionario['UnidadeOrganica']['name'] . '</h4>';
                        ...
                        <div class="col-sm-7 col-md-8">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <h3>Dados Profissionais e Contactos</h3>
                                    <hr>
                                </div>
                                <div class="col-md-6">
                                    <table class="table table-condensed table-hover">
                                        <thead>
                                        <tr>
                                            <th colspan="3">Funcoes que Desempenha</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <?php
                                            /**
                                             * @todo Listar Funcoes que Desempenha
                                             */
                                        ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <p> <?php
                                                if (isset($funcionario['Entidade']['Bairro']['name'])) {
                                                    echo h($funcionario['Entidade']['Bairro']['name']);
                                                }
                                            ?> </p>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <p> <?php echo h($funcionario['Entidade']['telemovel']) ?> </p>
                                    </div>
                                    <div class="form-group">
                                        <label class="label label-info control-label">
                                            Email Institucional
                                        ...
                                        <p> <?php echo h($funcionario['Entidade']['User']['username']) ?></p>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <p> <?php echo h($funcionario['Entidade']['email']) ?> </p>
