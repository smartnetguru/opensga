                    ...
                    <div id="step-1">
                        <row>
                            <div class="form-group col-sm-4">
                                <label for="numeroEstudante"
                                       class="control-label"><?= __('Numero de Estudante') ?></label>
                                <p class="form-control-static" id="numeroEstudante">
                                    <b><?= $this->request->data['Aluno']['numero_estudante'] ?></b></p>

                            </div>
                            <div class="form-group col-sm-4">
                                <label for="numeroEstudante" class="control-label"><?= __('Apelido') ?></label>
                                <p class="form-control-static" id="numeroEstudante">
                                    <b><?= $this->request->data['Entidade']['apelido'] ?></b></p>
                            ...
                            <div class="form-group col-sm-4">
                                <label for="numeroEstudante"
                                       class="control-label"><?= __('Numero de Estudante') ?></label>
                                <p class="form-control-static" id="numeroEstudante">
                                    <b><?= $this->request->data['Entidade']['nomes'] ?></b></p>
                        ...
                        <row>
                            <div class="form-group col-sm-3">
                                ...
                                <p class="form-control-static" id="numeroEstudante">
                                    <b><?= $this->request->data['Curso']['UnidadeOrganica']['name'] ?></b></p>

                            </div>
                            <div class="form-group col-sm-3">
                                <label for="numeroEstudante" class="control-label"><?= __('Curso') ?></label>
                                <p class="form-control-static" id="numeroEstudante">
                                    <b><?= $this->request->data['Curso']['name'] ?></b></p>

                            </div>
                            <div class="form-group col-sm-3">
                                <label for="numeroEstudante" class="control-label"><?= __('Ano de Ingresso') ?></label>
                                <p class="form-control-static" id="numeroEstudante">
                                    <b><?= $this->request->data['Aluno']['ano_ingresso'] ?></b></p>

                            </div>
                            <div class="form-group col-sm-3">
                                <label for="numeroEstudante"
                                       class="control-label"><?= __('Data de Matricula') ?></label>
                                <p class="form-control-static" id="numeroEstudante">
                                    <b><?= $this->request->data['Aluno']['data_ingresso'] ?></b></p>
                    ...
                    <div id="step-2">
                        <?php
                            ...
                            echo $this->Form->input('Aluno.nome_emergencia', [
                                    ...
                                    'label' => [
                                            'class' => 'control-label',
                                            'text'  => 'Pessoa de Contacto para Emergencias',
                                    ],
                                    'class' => 'form-control',
                                    'id'    => 'apelido',
                            ]);
                            ...
                            echo $this->Form->input('EntidadeIdentificacao.documento_identificacao_id', [
                                    ...
                                    'label'   => [
                                            'class' => 'control-label',
                                            'text'  => 'Tipo de Documento de Identificacao',
                                    ],
                                    'class'   => 'form-control',
                                    'id'      => 'apelido',
                            ...
                            echo $this->Form->input('EntidadeIdentificacao.numero', [
                                    ...
                                    'label' => [
                                            'class' => 'control-label',
                                            'text'  => 'Numero de Documento de Identificacao',
                                    ],
                                    'class' => 'form-control',
                                    'id'    => 'apelido',
                        ...
                        <div class="row">
                            ...
                            <div class="form-group">
                                <?php echo $this->Form->hidden('aluno_id',
                                        ['value' => $this->request->data['Aluno']['id']]); ?>
                                <?php
                                    echo $this->Form->end([
