...
<div class="actions">
    ...
    <ul>
        <li><?php echo $this->Html->link(__('Edit Tipo Upload'),
                    ['action' => 'edit', $tipoUpload['TipoUpload']['id']]); ?> </li>
        <li><?php echo $this->Form->postLink(__('Delete Tipo Upload'),
                    ['action' => 'delete', $tipoUpload['TipoUpload']['id']], null,
                    __('Are you sure you want to delete # %s?', $tipoUpload['TipoUpload']['id'])); ?> </li>
                ...
                <tr>
                    ...
                    <td class="actions">
                        <?php echo $this->Html->link(__('View'),
                                ['controller' => 'uploads', 'action' => 'view', $upload['id']]); ?>
                        <?php echo $this->Html->link(__('Edit'),
                                ['controller' => 'uploads', 'action' => 'edit', $upload['id']]); ?>
                        <?php echo $this->Form->postLink(__('Delete'),
                                ['controller' => 'uploads', 'action' => 'delete', $upload['id']], null,
                                __('Are you sure you want to delete # %s?', $upload['id'])); ?>
                    </td>
                </tr>
            <?php endforeach; ?>
        </table>
