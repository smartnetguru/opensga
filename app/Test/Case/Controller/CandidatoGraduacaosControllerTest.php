<?php
App::uses('CandidatoGraduacaosController', 'Controller');

/**
 * CandidatoGraduacaosController Test Case
 *
 */
class CandidatoGraduacaosControllerTest extends ControllerTestCase {
