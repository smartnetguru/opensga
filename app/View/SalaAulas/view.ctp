...
<div class="actions">
    ...
    <ul>
        <li><?php echo $this->Html->link(__('Edit Sala Aula'),
                    ['action' => 'edit', $salaAula['SalaAula']['id']]); ?> </li>
        <li><?php echo $this->Form->postLink(__('Delete Sala Aula'),
                    ['action' => 'delete', $salaAula['SalaAula']['id']], null,
                    __('Are you sure you want to delete # %s?', $salaAula['SalaAula']['id'])); ?> </li>
                    ...
                    <tr>
                        ...
                        <td class="actions">
                            ...
                            <?php echo $this->Form->postLink(__('Delete'),
                                    ['controller' => 'turmas', 'action' => 'delete', $turma['id']], null,
