...
foreach($candidatos as $candidato){
    ...
    $this->PhpExcel->xls->getActiveSheet()->setCellValue('D'.$linha_actual, $candidato['Aluno']['Entidade']['Genero']['name']);
    ...
    $this->PhpExcel->xls->getActiveSheet()->setCellValue('I'.$linha_actual, $candidato['Aluno']['Entidade']['data_nascimento']);
    $this->PhpExcel->xls->getActiveSheet()->setCellValue('J'.$linha_actual, $candidato['Aluno']['Entidade']['ProvinciaNascimento']['name']);
    $this->PhpExcel->xls->getActiveSheet()->setCellValue('K'.$linha_actual, $candidato['Aluno']['Entidade']['PaisNascimento']['name']);
    $linha_actual++;
    $i++;
}
