...
<div class="box box-100">
    <div class="boxin">
        ...
        <?php echo $this->Form->create('Turma', ['class' => 'fields']); ?>
        <fieldset>
                        ...
                        <table>
                            <tr>
                                <td>
                                    <label>
                                        Nome da Turma:
                                        <span class="hotspot" onmouseover="tooltip.show('Nome do Curso a Adicionar');"
                                              onmouseout="tooltip.hide();">?</span
                                    </label>
								<span class="input_wrapper blank">
									<?php echo $this->Form->input('name',
                                            ['label' => false, 'div' => false, 'class' => 'txt', 'size' => 45]); ?>
								</span>
                                </td>
                            </tr>
                            <tr>
                        ...
                        <table>
                            ...
                            <tr>
                                <td>
                                    <label>Turno:</label>
										<span class="input_wrapper blank">
											<?php echo $this->Form->input('turno',
                                                    ['label' => false, 'div' => false]); ?>
										</span>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <label>Numero Máximo de Alunos:</label>
										<span class="input_wrapper blank">
											<?php echo $this->Form->input('nummaximo',
                                                    ['label' => false, 'div' => false]); ?>
										</span>
                                </td>
                            </tr>
                    ...
                    <td width="49%">
                        <table>
                            <tr>
								...
								<span class="input_wrapper blank">
									<?php echo $this->Form->input('funcionario_id',
                                            ['label' => false, 'div' => false]); ?>
								</span>
                                </td>
                            </tr>
                    ...
                    <td width="49%">
                        <table width="100%">
                            <tr>
								...
								<span class="input_wrapper blank">
									<?php echo $this->Form->input('funcionario_ass_id',
                                            ['label' => false, 'div' => false]); ?>
                                    <span class="input_wrapper blank">
                                </td>
                            </tr>
                    ...
                    <td width="49%">
                        <table>
                            <tr>
								...
								<span class="input_wrapper blank">
									<?php echo $this->Form->input('estado', ['label' => false, 'div' => false]); ?>
								</span>
                                </td>
                            </tr>
                        </table>
        ...
        <table class="listingform" cellpadding="0" cellspacing="0">
            <tr>
                <td></td>
                <td><?php echo $this->Form->end(__('GRAVAR', true), ['class' => 'button']); ?></td>
            </tr>
        </table>
    </div>
</div>
