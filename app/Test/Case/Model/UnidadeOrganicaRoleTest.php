<?php
App::uses('UnidadeOrganicaRole', 'Model');

/**
 * UnidadeOrganicaRole Test Case
 *
 */
class UnidadeOrganicaRoleTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->UnidadeOrganicaRole = ClassRegistry::init('UnidadeOrganicaRole');
	}
 ...
 */
	public function tearDown() {
		unset($this->UnidadeOrganicaRole);
