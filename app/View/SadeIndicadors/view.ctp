...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Sade Indicador'), array('action' => 'edit', $sadeIndicador['SadeIndicador']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Sade Indicador'), array('action' => 'delete', $sadeIndicador['SadeIndicador']['id']), null, __('Are you sure you want to delete # %s?', $sadeIndicador['SadeIndicador']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('List Sade Indicadors'), array('action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(__('New Sade Indicador'), array('action' => 'add')); ?> </li>
...
<div class="related">
	...
	<?php
		...
		<tr>
			...
			<td class="actions">
				<?php echo $this->Html->link(__('View'), array('controller' => 'sade_parametros', 'action' => 'view', $sadeParametro['id'])); ?>
				<?php echo $this->Html->link(__('Edit'), array('controller' => 'sade_parametros', 'action' => 'edit', $sadeParametro['id'])); ?>
				<?php echo $this->Form->postLink(__('Delete'), array('controller' => 'sade_parametros', 'action' => 'delete', $sadeParametro['id']), null, __('Are you sure you want to delete # %s?', $sadeParametro['id'])); ?>
			</td>
		</tr>
	<?php endforeach; ?>
	</table>
