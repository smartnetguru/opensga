<div class="messageFolders index">
	...
	<tr>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $messageFolder['MessageFolder']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $messageFolder['MessageFolder']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $messageFolder['MessageFolder']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $messageFolder['MessageFolder']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
