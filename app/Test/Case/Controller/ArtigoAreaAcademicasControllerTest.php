<?php
App::uses('ArtigoAreaAcademicasController', 'Controller');

/**
 * ArtigoAreaAcademicasController Test Case
 */
class ArtigoAreaAcademicasControllerTest extends ControllerTestCase {
