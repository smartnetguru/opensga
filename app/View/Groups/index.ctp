        ...
        <div class="block-border">
            <div class="block-content">
                <ul class="shortcut-list">
                    <li>
                        <?php echo $this->Html->link($this->Html->image('icons/packs/crystal/48x48/apps/kedit.png') . __("Novo Grupo"),
                                ['controller' => 'groups', 'action' => 'novo_grupo'], ['escape' => false]) ?>
                    </li>
                </ul>
                <div class="clear"></div>
            </div>
                                ...
                                <tr<?php echo $class; ?>>
                                    ...
                                    <td class="actions">
                                        <?php echo $this->Html->link(__('Ver', true),
                                                ['action' => 'ver_grupo', $group['Group']['id']]); ?>
                                        <?php echo $this->Html->link(__('Editar', true),
                                                ['action' => 'editar_grupo', $group['Group']['id']]); ?>
                                        <?php echo $this->Form->postLink(__('Desactivar', true),
                                                ['action' => 'desactivar_grupo', $group['Group']['id']], null,
                                                sprintf(__('Tem certeza que pretende desactivar este grupo # %s?',
                                                        true), $group['Group']['name'])); ?>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
