...
$this->Html->addCrumb($this->request->data['UnidadeOrganica']['name'], '/unidade_organicas/edit/'.$this->request->data['UnidadeOrganica']['id']);
...
<div class="container_12">
    <div class="grid_6">
        <div class="block-border">
            ...
            <?php echo $this->Form->input('parent_id', array('label' => __('Unidade Orgânica Mãe'), 'div' => '_100', 'data-placeholder' => __('Seleccione'), 'empty' => true,'options'=>$parentUnidadeOrganicas)); ?>
...
lastXhr = $.getJSON( "<?php echo $this->Html->url(array('controller' => 'funcionarios', 'action' => 'autocomplete')) ?>", request, function( data, status, xhr ) {
cache[ term ] = data;
if ( xhr === lastXhr ) {
response( data );
}
