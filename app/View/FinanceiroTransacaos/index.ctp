<div class="financeiroTransacaos index">
	...
	<tr>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $financeiroTransacao['FinanceiroTransacao']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $financeiroTransacao['FinanceiroTransacao']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $financeiroTransacao['FinanceiroTransacao']['id']), null, __('Are you sure you want to delete # %s?', $financeiroTransacao['FinanceiroTransacao']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
