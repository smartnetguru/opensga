<div class="artigoMetas index">
	...
	<tr>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $artigoMeta['ArtigoMeta']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $artigoMeta['ArtigoMeta']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $artigoMeta['ArtigoMeta']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $artigoMeta['ArtigoMeta']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
