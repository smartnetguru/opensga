    ...
    <div class="container_12">
        <div class="grid_6">
            <div class="block-border">
                ...
                <div class="_100">
                    <p><label for="textfield">Tipo de Avaliação</label><?php echo $this->Form->input('tipoavaliacao_id',
                                ['label' => false, 'div' => false, 'class' => 'required']); ?></p>
                </div>
                <div class="_100">
                    <p><label for="textfield">Data e Hora</label><?php echo $this->Form->input('data',
                                ['type' => 'text', 'label' => false, 'div' => false, 'id' => 'dataAvaliacao']); ?></p>
                </div>
                <div class="_100">
                    <p><label for="textfield">Ordem</label><?php echo $this->Form->input('ordem',
                                ['label' => false, 'div' => false]); ?></p>
                </div>
                <div class="_100">
                    <p><label for="textfield">Peso</label><?php echo $this->Form->input('peso',
                                ['label' => false, 'div' => false]); ?></p>
                </div>
                ...
                <div class="block-actions">
                    <ul class="actions-left">
                        <li><?php echo $this->Html->link(__('Ver Turma'),
                                    ['controller' => 'turmas', 'action' => 'view', $turma['Turma']['id']],
                                    ['class' => 'button red']) ?></li>
                    </ul>
