    ...
    <dl>
        ...
        <dd>
            <?php echo $this->Html->link($sadeParametro['SadeIndicador']['id'],
                    ['controller' => 'sade_indicadors', 'action' => 'view', $sadeParametro['SadeIndicador']['id']]); ?>
            &nbsp;
        </dd>
...
<div class="actions">
    ...
    <ul>
        <li><?php echo $this->Html->link(__('Edit Sade Parametro'),
                    ['action' => 'edit', $sadeParametro['SadeParametro']['id']]); ?> </li>
        <li><?php echo $this->Form->postLink(__('Delete Sade Parametro'),
                    ['action' => 'delete', $sadeParametro['SadeParametro']['id']], null,
                    __('Are you sure you want to delete # %s?', $sadeParametro['SadeParametro']['id'])); ?> </li>
            ...
            <?php
                ...
                foreach ($sadeParametro['SadeAvaliacaoAluno'] as $sadeAvaliacaoAluno): ?>
                    <tr>
                        ...
                        <td class="actions">
                            <?php echo $this->Html->link(__('View'), [
                                    'controller' => 'sade_avaliacao_alunos',
                                    'action'     => 'view',
                                    $sadeAvaliacaoAluno['id'],
                            ]); ?>
                            <?php echo $this->Html->link(__('Edit'), [
                                    'controller' => 'sade_avaliacao_alunos',
                                    'action'     => 'edit',
                            ...
                            <?php echo $this->Form->postLink(__('Delete'), [
                                    ...
                                    'action'     => 'delete',
                                    $sadeAvaliacaoAluno['id'],
                            ], null, __('Are you sure you want to delete # %s?', $sadeAvaliacaoAluno['id'])); ?>
                        </td>
                    </tr>
                <?php endforeach; ?>
        </table>
