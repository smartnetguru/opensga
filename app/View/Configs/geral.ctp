			...
			<div class="grid_6">
				<div class="block-border">
					...
					<?php echo $this->Form->create('Config',array('class'=>'block-content form'));?>
						<div class="_100">
							<p><label for="textfield"><?php echo __("Chave da Configuração")?></label><?php echo $this->Form->input('name',array('label'=>false,'div'=>false,'class'=>'required','size'=>45));?></p>
						</div>
                                                <div class="_100">
							<p><label for="textfield"><?php echo __("Valor da Configuração")?></label><?php echo $this->Form->input('value',array('label'=>false,'div'=>false));?></p>
						</div>
                        <div class="_100">
							<p><label for="textfield"><?php echo __("Carregar Automaticamente")?></label><?php echo $this->Form->input('autoload',array('label'=>false,'div'=>false,'class'=>'txt'));?></p>
						</div>
                        <div class="_100">
							<p><label for="textfield"><?php echo __("Estado(Activo/Inactivo)")?></label><?php echo $this->Form->input('activo',array('label'=>false,'div'=>false,'class'=>'txt'));?></p>
						</div>
                        <div class="_100">
							<p><label for="textfield"><?php echo __("Descricao")?></label><?php echo $this->Form->input('descricao',array('label'=>false,'div'=>false,'class'=>'txt'));?></p>
						</div>                    
						<div class="clear"></div>
