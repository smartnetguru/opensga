...
<div class="projectos index" id="center-column">
    <div class="top-bar">
        <?php echo $this->Html->link(sprintf(__('Novo Cargo', true)), ['action' => 'add'], ['class' => 'button']); ?>
                    ...
                    <tr<?php echo $class; ?>>
                        ...
                        <td class="accoes">
                            <?php echo $this->Html->image("/img/login-icon.gif", [
                                    "alt"   => "Brownies",
                                    "title" => "Visualizar",
                                    'url'   => ['action' => 'view', $cargo['Cargo']['id']],
                            ]); ?>
                            <?php echo $this->Html->image("/img/edit-icon.gif", [
                                    "alt"   => "Brownies",
                                    "title" => "Editar",
                                    'url'   => ['action' => 'edit', $cargo['Cargo']['id']],
                            ]); ?>
                            <?php echo $this->Html->image("/img/hr.gif", [
                                    "alt"   => "Brownies",
                                    "title" => "Remover",
                                    'url'   => ['action' => 'delete', $cargo['Cargo']['id']],
                                    null,
                                    sprintf(__('Tem a certeza que deseja eliminar # %s?', true), $cargo['Cargo']['id']),
                            ]); ?>
