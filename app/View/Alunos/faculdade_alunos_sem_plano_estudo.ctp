...
<div class="action-list">
	<div class="col-sm-1">
		<?php echo $this->Html->link('<i class="fa fa-user fa-2x"></i>Matricular Candidato', array('controller' => 'alunos', 'action' => 'pesquisa_candidatos_action', 'matricular_candidato'), array('escape' => false, 'class' => 'btn btn-icon btn-block')) ?>
	</div>
	<div class="col-sm-1">
