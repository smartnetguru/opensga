        ...
        <?php
            ...
            foreach ($feriados as $feriado): ?>
                <tr>
                    ...
                    <td class="actions">
                        <?php echo $this->Html->link(__('View'), ['action' => 'view', $feriado['Feriado']['id']]); ?>
                        <?php echo $this->Html->link(__('Edit'), ['action' => 'edit', $feriado['Feriado']['id']]); ?>
                        <?php echo $this->Form->postLink(__('Delete'),
                                ['action' => 'delete', $feriado['Feriado']['id']], null,
                                __('Are you sure you want to delete # %s?', $feriado['Feriado']['id'])); ?>
                    </td>
                </tr>
            <?php endforeach; ?>
    </table>
