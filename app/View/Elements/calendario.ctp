...
<div class="calendar">
    <div class="calendar_top">
							<span> 
								<?php echo iconv('ISO-8859-2', 'UTF-8',
                                        strftime("%A, %d  de %B de %Y", mktime())); ?> </span>
    </div>
                ...
                <div class="ctrl">
                    <table cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            <td align="center"><span><strong><?php echo iconv('ISO-8859-2', 'UTF-8',
                                                strftime("%B de %Y", $first_of_month)); ?> </strong></span></td>
            ...
            <div class="cont">
                ...
                <ul class="cdays">
                    ...
                    <?php for ($day = 1; $day <= $num_days; ++$day): ?>
                        ...
                        <li>
                            <?php if (in_array($day, $dferiados)) { ?><a style="background-color: red"
                                                                         href="#"><?php echo $day ?></a><?php } else { ?>
