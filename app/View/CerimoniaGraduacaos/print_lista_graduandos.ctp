...
//$this->PhpExcel->xls->getActiveSheet()->setCellValue('A8', "Docente:");
    ...
    foreach ($candidatos as $candidato) {
        ...
        $this->PhpExcel->xls->getActiveSheet()->setCellValue('E' . $linha_actual,
            $candidato['Aluno']['Curso']['UnidadeOrganica']['name']);
        ...
        $this->PhpExcel->xls->getActiveSheet()->setCellValue('G' . $linha_actual,
            $candidato['CandidatoGraduacao']['data_defesa']);
        ...
        $this->PhpExcel->xls->getActiveSheet()->setCellValue('I' . $linha_actual,
            $candidato['EstadoCandidatura']['name']);
        $this->PhpExcel->xls->getActiveSheet()->setCellValue('J' . $linha_actual,
            $candidato['Aluno']['Entidade']['data_nascimento']);
        $this->PhpExcel->xls->getActiveSheet()->setCellValue('K' . $linha_actual,
            $candidato['ProvinciaNascimento']['name']);
        $this->PhpExcel->xls->getActiveSheet()->setCellValue('L' . $linha_actual,
            $candidato['Aluno']['Entidade']['PaisNascimento']['name']);
        $this->PhpExcel->xls->getActiveSheet()->setCellValue('M' . $linha_actual,
            $candidato['FinanceiroDeposito']['valor']);
        $this->PhpExcel->xls->getActiveSheet()->setCellValue('N' . $linha_actual,
            $candidato['CandidatoGraduacao']['telemovel']);
