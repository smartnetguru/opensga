<?php
App::uses('UserLoginHistoriesController', 'Controller');

/**
 * UserLoginHistoriesController Test Case
 */
class UserLoginHistoriesControllerTest extends ControllerTestCase {
