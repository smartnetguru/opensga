...
<div class="actions">
    ...
    <ul>
        <li><?php echo $this->Html->link(__('Edit Docente Categoria', true),
                    ['action' => 'edit', $docenteCategoria['DocenteCategoria']['id']]); ?> </li>
        <li><?php echo $this->Html->link(__('Delete Docente Categoria', true),
                    ['action' => 'delete', $docenteCategoria['DocenteCategoria']['id']], null,
                    sprintf(__('Are you sure you want to delete # %s?', true),
                            $docenteCategoria['DocenteCategoria']['id'])); ?> </li>
        <li><?php echo $this->Html->link(__('List Docente Categorias', true), ['action' => 'index']); ?> </li>
        <li><?php echo $this->Html->link(__('New Docente Categoria', true), ['action' => 'add']); ?> </li>
                    ...
                    <tr<?php echo $class; ?>>
                        ...
                        <td class="actions">
                            ...
                            <?php echo $this->Html->link(__('Delete', true),
                                    ...
                                    sprintf(__('Are you sure you want to delete # %s?', true), $docente['id'])); ?>
                        </td>
                    </tr>
                <?php endforeach; ?>
        </table>
