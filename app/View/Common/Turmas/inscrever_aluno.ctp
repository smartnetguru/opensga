    ...
    <div class="col-sm-6">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <?php echo $this->Form->create('Inscricao', array('role' => 'form', 'class' => '', 'inputDefaults' => array())); ?>
                <?php

                    echo $this->Form->input('tipo_inscricao_id',
                        array('label' => array(
                            'class'=>'control-label','text'=>'Tipo de Frequencia'
                        ),
                    ...
                    echo $this->Form->input('nota_frequencia',
                        array('label' => array(
                            'class'=>'control-label','text'=>'Nota de Frequencia'
                        ),
                              'div' => 'form-group col-sm-12',
                              'class' => 'form-control',
                              'id' => 'notaFrequencia',
                    ...
                    echo $this->Form->input('nota_exame_normal',
                        array('label' => array(
                            'class'=>'control-label','text'=>'Nota de Exame Normal'
                        ),
                    ...
                    echo $this->Form->input('nota_exame_recorrencia',
                        array('label' => array(
                            'class'=>'control-label','text'=>'Nota de Exame de Recorrencia'
                        ),
                              'div' => 'form-group col-sm-6 ',
                              'class' => 'form-control',
                    ...
                    echo $this->Form->input('nota_final',
                        array('label' => array(
                            'class'=>'control-label','text'=>'Nota Final'
                        ),
                              'div' => 'form-group col-sm-12',
                              'class' => 'form-control',
                              'id' => 'notaFinal',
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4 col-sm-offset-4">
                        ...
                        <?php
                            echo $this->Form->input('turma_id',array('type'=>'hidden','value'=>$turma['Turma']['id']));
                            echo $this->Form->input('aluno_id',array('type'=>'hidden','value'=>$aluno['Aluno']['id']));
                            echo $this->Form->end(array('label' => __('ACTUALIZAR', true), 'class' => 'btn btn-blue btn-block'));
                        ?>
