...
<?php echo $this->Form->create('CooperacaoAcordoArea'); ?>
	<fieldset>
		<legend><?php echo __('Edit Cooperacao Acordo Area'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('CooperacaoAcordoArea.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('CooperacaoAcordoArea.id'))); ?></li>
