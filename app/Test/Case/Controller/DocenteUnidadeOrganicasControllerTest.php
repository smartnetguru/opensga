<?php
App::uses('DocenteUnidadeOrganicasController', 'Controller');

/**
 * DocenteUnidadeOrganicasController Test Case
 */
class DocenteUnidadeOrganicasControllerTest extends ControllerTestCase {
