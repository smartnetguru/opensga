<?php
App::uses('FinanceiroDepositosController', 'Controller');

/**
 * FinanceiroDepositosController Test Case
 *
 */
class FinanceiroDepositosControllerTest extends ControllerTestCase {
