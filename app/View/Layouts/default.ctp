            ...
            <ul class="main-navigation-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu">
                        ...
                        <li><?php echo $this->Html->link(sprintf(__('Plano de Estudos', true)),
                                ['controller' => 'plano_estudos', 'action' => 'index'], ['class' => 'link']); ?></li>
                        <li>
                            <?php
                ...
                <li>
                    ...
                    <ul class="sub-menu">
                        ...
                        <li><?php echo $this->Html->link(sprintf(__('Acordos de Cooperação', true)),
                                ['controller' => 'cooperacao_acordos', 'action' => 'index', 'plugin' => 'cooperacao'],
                                ['class' => 'link']); ?></li>
                    </ul>
                </li>
                <li>
                ...
                <li>
                    ...
                    <ul class="sub-menu">
                        ...
                        <li>    <?php echo $this->Html->link(sprintf(__('Cidades', true)), ['controller' => 'cidades'],
                                ['class' => 'link']); ?></li>
                        <li>    <?php echo $this->Html->link(sprintf(__('Cargos', true)), ['controller' => 'cargos'],
                                ['class' => 'link']); ?></li>
                        ...
                        <li>     <?php echo $this->Html->link(sprintf(__('Turnos', true)), ['controller' => 'turnos'],
                                ['class' => 'link']); ?></li>
                        <li>    <?php echo $this->Html->link(sprintf(__('Escolas', true)), ['controller' => 'escolas'],
                                ['class' => 'link']); ?></li>
