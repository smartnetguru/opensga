<?php
App::uses('FinanceiroFormaDeposito', 'Model');

/**
 * FinanceiroFormaDeposito Test Case
 *
 */
class FinanceiroFormaDepositoTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->FinanceiroFormaDeposito = ClassRegistry::init('FinanceiroFormaDeposito');
	}
 ...
 */
	public function tearDown() {
		unset($this->FinanceiroFormaDeposito);
