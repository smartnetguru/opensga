        ...
        <div class="block-border">
            <div class="block-content">
                <ul class="shortcut-list">
                    <li>
                        <?php echo $this->Html->link($this->Html->image('icons/packs/crystal/48x48/apps/kedit.png') . __("Novo Tipo de Unidade"),
                                ['controller' => 'tipo_unidade_organicas', 'action' => 'add'], ['escape' => false]) ?>
                    </li>
                </ul>
                <div class="clear"></div>
            </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php echo $this->Html->link(__('Ver'),
                                            ['action' => 'view', $tipoUnidadeOrganica['TipoUnidadeOrganica']['id']]); ?>
                                    <?php echo $this->Html->link(__('Editar'),
                                            ['action' => 'edit', $tipoUnidadeOrganica['TipoUnidadeOrganica']['id']]); ?>
                                    <?php echo $this->Form->postLink(__('Remover'),
                                            ['action' => 'delete', $tipoUnidadeOrganica['TipoUnidadeOrganica']['id']],
                                            null, __('Tem Certeza que deseja remover?',
                                                    $tipoUnidadeOrganica['TipoUnidadeOrganica']['id'])); ?>
                                </td>
                            </tr>
                        <?php endforeach; ?>
