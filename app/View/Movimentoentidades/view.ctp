...
<div class="actions">
    ...
    <ul>
        <li><?php echo $this->Html->link(sprintf(__('Edit %s', true), __('Movimentoentidade', true)),
                    ['action' => 'edit', $movimentoentidade['Movimentoentidade']['id']]); ?> </li>
        <li><?php echo $this->Html->link(sprintf(__('Delete %s', true), __('Movimentoentidade', true)),
                    ['action' => 'delete', $movimentoentidade['Movimentoentidade']['id']], null,
                    sprintf(__('Are you sure you want to delete # %s?', true),
                            $movimentoentidade['Movimentoentidade']['id'])); ?> </li>
        <li><?php echo $this->Html->link(sprintf(__('List %s', true), __('Movimentoentidades', true)),
                    ['action' => 'index']); ?> </li>
