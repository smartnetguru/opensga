...
<?php echo $this->Form->create('CerimoniaGraduacao', array('role' => 'form', 'class' => '', 'inputDefaults' => array())); ?>
<?php
    echo $this->Form->input('name',
        array('label' => array(
            'class'=>'control-label','text'=>'Designacao'
        ),
              'div' => 'form-group',
              'class' => 'form-control',
              'id' => 'codigoID',
    ...
    echo $this->Form->input('data',
        array('label' => array(
            'class'=>'control-label','text'=>'Data'
              ...
              'between'=>$before,'after'=>$after
        )
    );
    echo $this->Form->input('local',
        array('label' => array(
            'class'=>'control-label','text'=>'Local'
        ),
              'div' => 'form-group',
              'class' => 'form-control',
              'id' => 'anoID',
