...
<div class="box box-100 altbox" id="box1"><!-- box full-width -->
    <div class="boxin">
        <div class="header">
            ...
            <?php echo $this->Html->link(__('Registrar novo', true), ['action' => 'add'],
                    ['class' => 'button add_new', 'escape' => false]); ?>
        ...
        <div class="content" id="box1-tabular"><!-- content box 1 for tab switching -->
            <form enctype="multipart/form-data" method="post" action="" class="plain">
                <fieldset>
                    <?php echo $this->Form->create('Curso', ['action' => 'index', 'id' => 'filters']); ?>
                    <table cellspacing="0">
                        <thead><!-- universal table heading -->
                        <tr>
                            <td class="tc first"><input type="checkbox" value="true" name="data-1-check-all"
                                                        id="data-1-check-all"></td>
                        ...
                        <tr>
                            ...
                            <td><?php echo $this->Form->input('codigo', ['label' => false, 'size' => 8]); ?></td>
                            <td><?php echo $this->Form->input('name', ['label' => false, 'size' => 10]); ?></td>
                            <td><?php echo $this->Form->input('name', ['label' => false, 'size' => 10]); ?></td>
                        ...
                        <tr>
                            <td colspan="6" class="first last">
                                <!-- do not forget to set appropriate colspan if you will edit this table -->
                                <label>
                                ...
                                <tr<?php echo $class; ?>>
                                    ...
                                    <td class="accoes">
                                        <?php echo $this->Html->image("/img/login-icon.gif", [
                                                "alt" => "Brownies",
                                                'url' => ['action' => 'view', $tipoavaliacao['TipoAvaliacao']['id']],
                                        ]); ?>
                                        <?php if ($grupo == 1) {
                                            echo $this->Html->image("/img/edit-icon.gif", [
                                                    "alt" => "Brownies",
                                                    'url' => ['action' => 'edit', $tipoavaliacao['TipoAvaliacao']['id']],
                                            ]);
                                        } ?>
                                        <?php if ($grupo == 1) {
                                            echo $this->Html->image("/img/hr.gif", [
                                                    ...
                                                    'url' => [
                                                            'action' => 'delete',
                                                            $tipoavaliacao['TipoAvaliacao']['id'],
                                                    ],
                                                    null,
            ...
            <div class="pagination">
                ...
                <ul>
                    <li><?php echo $this->Paginator->prev('<<', [], null, ['class' => 'disabled']); ?> </li>
                    <?php echo $this->Paginator->numbers(['tag' => 'li', 'separator' => null]); ?>

                    <li><?php echo $this->Paginator->next('>>', [], null, ['class' => 'disabled']); ?></li>
                </ul>
