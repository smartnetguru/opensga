                ...
                <ul class="nav navbar-right">
                    <?php
                        ...
                        if (isset($userGroups)) {
                            ...
                            echo $this->Form->create('User', ['url' => array('controller' => 'users', 'action' => 'changeLoginProfile'),'class' => 'dropdown-toggle']);
                            echo $this->Form->input('group_id',
                                ['options' => $userGroups, 'label' => false,'selected' => $groupId ,'onchange' => 'this.form.submit()']);
                            echo $this->Form->end();
                            echo '</li>';
                        }
                    ?>
                    ...
                    <?php if (isset($totalTarefasPendentes)): ?>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu todo">
                                <li>
                                    <span class="dropdown-menu-title"> VOce tem <?php  echo $totalTarefasPendentes;?> tarefas pendentes</span>
                                </li>
                                <li>
                    ...
                    <?php if (isset($totalNotificacoesPendentes)): ?>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu notifications">
                                <li>
                                    <span class="dropdown-menu-title"> Voce tem <?php echo $totalNotificacoesPendentes;?> notificacoes</span>
                                </li>
                                <li>
                                    <div class="drop-down-wrapper">
                                        <ul>
                                ...
                                <li>
                                    <div class="drop-down-wrapper">
                                        <ul>
                                            ...
                                            <li>
                                                <a href="<?= $this->Html->url(['controller'=>'messages','action'=>'ver_mensagem',$message['Message']['id']])?>">
                                                    <div class="clearfix">
                                                        <div class="thread-image">
                                                            <img alt="" src="<?= $message['Message']['User']['profile_picture_url']?>">
                                                        </div>
                    ...
                    <li class="dropdown current-user">
                        ...
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            ...
                            ?>
                            <?php echo $this->Html->image($signedUrl, ['style' => 'max-width:30px;max-height:30px']); ?>
                                <?php endif;?>
                    ...
                    <li>
                        <a class="sb-toggle" href="#" onclick="ga('send', 'event', 'Links', 'chat Aberto', 'Aberto');"><i class="fa fa-outdent"></i></a>
                    </li>
