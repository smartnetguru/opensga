...
<?php echo $this->Form->create('EntidadeIdentificacao'); ?>
	<fieldset>
		<legend><?php echo __('Edit Entidade Identificacao'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('EntidadeIdentificacao.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('EntidadeIdentificacao.id'))); ?></li>
