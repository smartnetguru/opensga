...
<div class="actions">
    ...
    <ul>
        <li><?php echo $this->Html->link(__('Edit Docente Funcao'),
                    ['action' => 'edit', $docenteFuncao['DocenteFuncao']['id']]); ?> </li>
        <li><?php echo $this->Form->postLink(__('Delete Docente Funcao'),
                    ['action' => 'delete', $docenteFuncao['DocenteFuncao']['id']], null,
                    __('Are you sure you want to delete # %s?', $docenteFuncao['DocenteFuncao']['id'])); ?> </li>
        <li><?php echo $this->Html->link(__('List Docente Funcaos'), ['action' => 'index']); ?> </li>
        <li><?php echo $this->Html->link(__('New Docente Funcao'), ['action' => 'add']); ?> </li>
