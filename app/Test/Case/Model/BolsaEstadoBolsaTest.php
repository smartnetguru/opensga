<?php
App::uses('BolsaEstadoBolsa', 'Model');

/**
 * BolsaEstadoBolsa Test Case
 *
 */
class BolsaEstadoBolsaTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->BolsaEstadoBolsa = ClassRegistry::init('BolsaEstadoBolsa');
	}
