...
<div class="actions">
    ...
    <ul>
        <li><?php echo $this->Html->link(__('Edit Regime Estudo'),
                    ['action' => 'edit', $regimeEstudo['RegimeEstudo']['id']]); ?> </li>
        <li><?php echo $this->Form->postLink(__('Delete Regime Estudo'),
                    ['action' => 'delete', $regimeEstudo['RegimeEstudo']['id']], null,
                    __('Are you sure you want to delete # %s?', $regimeEstudo['RegimeEstudo']['id'])); ?> </li>
