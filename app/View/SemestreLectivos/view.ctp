    ...
    <dl>
        ...
        <dd>
            <?php echo $this->Html->link($semestreLectivo['AnoLectivo']['codigo'],
                    ['controller' => 'ano_lectivos', 'action' => 'view', $semestreLectivo['AnoLectivo']['id']]); ?>
            &nbsp;
        </dd>
...
<div class="actions">
    ...
    <ul>
        <li><?php echo $this->Html->link(__('Edit Semestre Lectivo'),
                    ['action' => 'edit', $semestreLectivo['SemestreLectivo']['id']]); ?> </li>
        <li><?php echo $this->Form->postLink(__('Delete Semestre Lectivo'),
                    ['action' => 'delete', $semestreLectivo['SemestreLectivo']['id']], [],
                    __('Are you sure you want to delete # %s?', $semestreLectivo['SemestreLectivo']['id'])); ?> </li>
                ...
                <tr>
                    ...
                    <td class="actions">
                        ...
                        <?php echo $this->Form->postLink(__('Delete'), [
                                ...
                                'action'     => 'delete',
                                $financeiroDeposito['id'],
                        ], [], __('Are you sure you want to delete # %s?', $financeiroDeposito['id'])); ?>
                    </td>
                </tr>
            <?php endforeach; ?>
        </table>
                ...
                <tr>
                    ...
                    <td class="actions">
                        ...
                        <?php echo $this->Form->postLink(__('Delete'), [
                                ...
                                'action'     => 'delete',
                                $financeiroPagamento['id'],
                        ], [], __('Are you sure you want to delete # %s?', $financeiroPagamento['id'])); ?>
                    </td>
                </tr>
            <?php endforeach; ?>
        </table>
