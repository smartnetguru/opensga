...
foreach($inscricaos as $inscricao){
    ...
    $this->PhpExcel->xls->getActiveSheet()->setCellValue('B'.$linha_actual, $inscricao['Matricula']['Aluno']['codigo']);
    $this->PhpExcel->xls->getActiveSheet()->setCellValue('C'.$linha_actual, $inscricao['Matricula']['Aluno']['Entidade']['apelido']);
    $this->PhpExcel->xls->getActiveSheet()->setCellValue('D'.$linha_actual, $inscricao['Matricula']['Aluno']['Entidade']['nomes']);
    $this->PhpExcel->xls->getActiveSheet()->setCellValue('E'.$linha_actual, $inscricao['Matricula']['Aluno']['Entidade']['User']['username']);
    $linha_actual++;
    $i++;
}
