...
<div class="actions" id="left-column">
    ...
    <?php echo $this->Html->link(sprintf(__('Áreas de Trabalho', true)), ['controller' => 'tg0010areatrabalhos'],
            ['class' => 'link']); ?>
    <?php echo $this->Html->link(sprintf(__('Tipos de Funcionário', true)), ['controller' => 'Tg0011tipofuncionarios'],
            ['class' => 'link']); ?>
    <?php echo $this->Html->link(sprintf(__('Turnos', true)), ['controller' => 'tg0012turnos'], ['class' => 'link']); ?>
    <?php echo $this->Html->link(sprintf(__('Tipos de Movimento', true)), ['controller' => 'tg0015tipomovimentos'],
            ['class' => 'link']); ?>
    <?php echo $this->Html->link(sprintf(__('Escolas', true)), ['controller' => 'tg0016escolas'],
            ['class' => 'link']); ?>
    <?php echo $this->Html->link(sprintf(__('Estados das Mensagens', true)), ['controller' => 'tg0018estadomessages'],
            ['class' => 'link']); ?>
    <?php echo $this->Html->link(sprintf(__('Estados das Inscrições', true)),
            ['controller' => 'tg0020estadoinscricaos'], ['class' => 'link']); ?>
    <?php echo $this->Html->link(sprintf(__('Estados das Matriculas', true)),
            ['controller' => 'tg0021estadomatriculas'], ['class' => 'linkselected']); ?>
    <?php echo $this->Html->link(sprintf(__('Géneros', true)), ['controller' => 'tg0019generos'],
            ['class' => 'link']); ?>
