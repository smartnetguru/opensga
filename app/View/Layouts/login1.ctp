...
<html lang="en" class="no-js"  manifest="/cache.manifest">
	...
	<head>
		...
		echo $this->Html->css('/assets/css/print.css', array('media' => 'print'));
		?>
...
<?php
echo $this->Html->script(array('libs/jquery-1.10.2'));
...
echo $this->Html->script(array('/assets/plugins/jquery-validation/dist/jquery.validate.min.js'));
echo $this->Html->script(array('/assets/js/login.js'));
?>
