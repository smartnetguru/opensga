...
<div class="actions">
    ...
    <ul>
        ...
        <li><?php echo $this->Html->link(__('Delete', true), ['action' => 'delete', $this->Form->value('Conta.id')],
                    null,
                    sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('Conta.id'))); ?></li>
