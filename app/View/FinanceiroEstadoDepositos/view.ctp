<div class="financeiroEstadoDepositos view">
<h2><?php  echo __('Financeiro Estado Deposito'); ?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($financeiroEstadoDeposito['FinanceiroEstadoDeposito']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Name'); ?></dt>
		<dd>
			<?php echo h($financeiroEstadoDeposito['FinanceiroEstadoDeposito']['name']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Financeiro Estado Deposito'), array('action' => 'edit', $financeiroEstadoDeposito['FinanceiroEstadoDeposito']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Financeiro Estado Deposito'), array('action' => 'delete', $financeiroEstadoDeposito['FinanceiroEstadoDeposito']['id']), null, __('Are you sure you want to delete # %s?', $financeiroEstadoDeposito['FinanceiroEstadoDeposito']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('List Financeiro Estado Depositos'), array('action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(__('New Financeiro Estado Deposito'), array('action' => 'add')); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($financeiroEstadoDeposito['FinanceiroDeposito'])): ?>
	...
	<?php
		$i = 0;
		foreach ($financeiroEstadoDeposito['FinanceiroDeposito'] as $financeiroDeposito): ?>
		<tr>
