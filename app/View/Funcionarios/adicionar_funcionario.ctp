    ...
    <div class="col-sm-12">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
				<?php echo $this->Form->create('Funcionario', array('role' => "form", 'novalidade' => 'novalidate', 'enctype' => 'multipart/form-data', 'class' => 'smart-wizard form-horizontal', 'id' => 'form', 'inputDefaults' => array('label' => false, 'div' => false, 'empty' => 'Seleccione', 'placeholder' => 'Seleccione'))); ?>
                    ...
                    <div id="step-1">
                        <div class="form-group">
                            <fieldset>
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
										<?php echo $this->Form->label('Funcionario.codigo', 'Codigo do Funcionario'); ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3">
										...
										<?php echo $this->Form->input('Entidade.cidade_nascimento', array('class' => 'form-control', 'id' => 'cidadeNascimento', 'options' => $cidades)); ?>
                                    </div>
                                </div>
                    ...
                    <div id="step-2">
                        <div class="form-group">
                            <fieldset>
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
										<?php echo $this->Form->label('Funcionario.unidade_organica_id', 'Unidade Organica'); ?>
										<?php echo $this->Form->input('Funcionario.unidade_organica_id',
                                            array('class' => 'form-control', 'id' => 'unidadeOrganicaId',
                                                'options'=>$unidadeOrganicas)); ?>
                                    </div>
                                    <div class="col-sm-4">
										<?php echo $this->Form->label('Funcionario.tipo_funcionario_id', 'Tipo de Funcionario'); ?>
										<?php echo $this->Form->input('Funcionario.tipo_funcionario_id', array('class' => 'form-control')); ?>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group">
											<?php echo $this->Form->label('Funcionario.data_admissao', 'Data de Admissao'); ?>
                                            <div class="input-group">
												<?php echo $this->Form->input('Funcionario.data_admissao', array('class' => 'form-control date-picker', 'id' => 'firstname', 'type' => 'text', 'data-date-viewmode' => 'years', 'data-date-format' => 'yyyy-mm-dd')); ?>
                                                <span class="input-group-addon"> <i class="fa fa-calendar"></i> </span>
                                            </div>
                                        </div>
                                ...
                                <div class ="row">
                                    <div class="col-sm-6">
										<?php echo $this->Form->label('Funcionario.grau_academico_id', 'Grau Academico'); ?>
										<?php echo $this->Form->input('Funcionario.grau_academico_id', array('class' => 'form-control search-select', 'empty' => true, 'data-placeholder' => 'Seleccione...')); ?>
                                    </div>
                                    <div class="col-sm-6">
										<?php echo $this->Form->label('Funcionario.cargo_id', 'Cargo'); ?>
										<?php echo $this->Form->input('Funcionario.cargo_id', array('label' => false, 'div' => false, 'class' => 'form-control', 'id' => 'codigo')); ?>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-6">
										<?php echo $this->Form->label('Funcionario.superior_hierarquico', 'Superior Hierarquico'); ?>
										<?php echo $this->Form->input('Funcionario.superior_hierarquico', array('class' => 'form-control', 'id' => 'codigo', 'type' => 'text')); ?>
                                    </div>
                                    <div class="col-sm-6">
										<?php echo $this->Form->label('Funcionario.categoria_funcionario_id', 'Categoria do Funcionario'); ?>
										<?php echo $this->Form->input('Funcionario.categoria_funcionario_id', array('class' => 'form-control', 'id' => 'codigo')); ?>
                                    </div>
                                    <div class="col-sm-6">
										<?php echo $this->Form->label('Funcionario.categoria_profissional_id', 'Entregou Certificado?'); ?>
										<?php echo $this->Form->input('Funcionario.categoria_profissional_id', array('label' => false, 'div' => false, 'class' => 'form-control', 'id' => 'codigo')); ?>
                                    </div>
                            ...
                            <fieldset>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
										...
										<?php echo $this->Form->input('EntidadeContacto.9', array('class' => 'form-control', 'id' => 'cidadeMorada', 'options' => $cidades, 'data-placeholder' => "Seleccione...", 'empty' => true)); ?>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-3">
                            ...
                            <fieldset>
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
										...
										<?php echo $this->Form->input('EntidadeIdentificacao.documento_identificacao_id', array('class' => 'form-control', 'id' => 'codigo', 'options' => $documentoIdentificacaos)); ?>
                                    </div>
                                    <div class="col-sm-4">
