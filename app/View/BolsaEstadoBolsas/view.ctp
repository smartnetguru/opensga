...
<div class="actions">
    ...
    <ul>
        <li><?php echo $this->Html->link(__('Edit Bolsa Estado Bolsa'),
                    ['action' => 'edit', $bolsaEstadoBolsa['BolsaEstadoBolsa']['id']]); ?> </li>
        <li><?php echo $this->Form->postLink(__('Delete Bolsa Estado Bolsa'),
                    ['action' => 'delete', $bolsaEstadoBolsa['BolsaEstadoBolsa']['id']], null,
                    __('Are you sure you want to delete # %s?', $bolsaEstadoBolsa['BolsaEstadoBolsa']['id'])); ?> </li>
        <li><?php echo $this->Html->link(__('List Bolsa Estado Bolsas'), ['action' => 'index']); ?> </li>
