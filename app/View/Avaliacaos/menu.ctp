...
<div class="actions" id="left-column">
    ...
    <br/>
    <?php if ($grupo == 1 || $grupo == 4) {
        echo $this->Html->link(sprintf(__('Avaliacao', true)),
                ['controller' => 'avaliacaos', 'action' => 'registo_de_notas'], ['class' => 'linkselected']);
    } ?>

    <?php if ($grupo == 3) {
        echo $this->Html->link(sprintf(__('Avaliacao', true)), ['controller' => 'avaliacaos', 'action' => 'index'],
                ['class' => 'linkselected']);
    } ?>

    <?php if ($grupo != 3) {
        echo $this->Html->link(sprintf(__('Tipo de Avaliacoes', true)),
                ['controller' => 'tipoavaliacaos', 'action' => 'index'], ['class' => 'link']);
    } ?>

    <?php if ($grupo != 3) {
        echo $this->Html->link(sprintf(__('Épocas de Avaliação', true)),
