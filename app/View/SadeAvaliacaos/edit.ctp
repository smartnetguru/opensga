...
<?php echo $this->Form->create('SadeAvaliacao');?>
	<fieldset>
		<legend><?php echo __('Edit Sade Avaliacao'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('SadeAvaliacao.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('SadeAvaliacao.id'))); ?></li>
