<?php
App::uses('FinanceiroTransacaosController', 'Controller');

/**
 * FinanceiroTransacaosController Test Case
 *
 */
class FinanceiroTransacaosControllerTest extends ControllerTestCase {
