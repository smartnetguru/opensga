...
<div class="projectos index" id="center-column">
    <div class="top-bar">
        <?php echo $this->Html->link(sprintf(__('Novo Pais', true)), ['action' => 'add'], ['class' => 'button']); ?>
                    ...
                    <tr<?php echo $class; ?>>
                        ...
                        <td class="accoes">
                            <?php echo $this->Html->image("/img/login-icon.gif", [
                                    "alt"   => "Brownies",
                                    "title" => "Visualizar",
                                    'url'   => ['action' => 'view', $paise['Paise']['id']],
                            ]); ?>
                            <?php echo $this->Html->image("/img/edit-icon.gif", [
                                    "alt"   => "Brownies",
                                    "title" => "Editar",
                                    'url'   => ['action' => 'edit', $paise['Paise']['id']],
                            ]); ?>
                            <?php echo $this->Html->image("/img/hr.gif", [
                                    "alt"   => "Brownies",
                                    "title" => "Eliminar",
                                    'url'   => ['action' => 'delete', $paise['Paise']['id']],
                                    null,
                                    sprintf(__('Tem a certeza que deseja eliminar # %s?', true), $paise['Paise']['id']),
                            ]); ?>
                        </td>
