...
<?php echo $this->Form->create('Alumni'); ?>
	<fieldset>
		<legend><?php echo __('Edit Alumni'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Alumni.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Alumni.id'))); ?></li>
