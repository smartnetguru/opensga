    ...
    class MatriculaShell extends AppShell
    {
        ...
        public function processaMatriculaRenovada()
        {
            ...
            $tarefa = $this->Tarefa->find('all', [
                'conditions' => [
                    'Tarefa.user_id' => $matricula['Aluno']['Entidade']['user_id'],
                    'Tarefa.name Like' => '%Renovar Matricula%',
                ],
            ]);
            if ($tarefa) {
            ...
            $this->Message->sendMessage(1, $matricula['Aluno']['Entidade']['User']['id'],
                'Confirmacao de Renovacao de Matricula', $mensagem);

            $this->Notification->sendNotification($matricula['Aluno']['Entidade']['User']['id'],
                'Renovacao de Matricula Confirmada', 'Matricula');
