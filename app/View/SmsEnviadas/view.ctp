...
<div class="actions">
    ...
    <ul>
        <li><?php echo $this->Html->link(__('Edit Sms Enviada'),
                    ['action' => 'edit', $smsEnviada['SmsEnviada']['id']]); ?> </li>
        <li><?php echo $this->Form->postLink(__('Delete Sms Enviada'),
                    ['action' => 'delete', $smsEnviada['SmsEnviada']['id']], null,
                    __('Are you sure you want to delete # %s?', $smsEnviada['SmsEnviada']['id'])); ?> </li>
