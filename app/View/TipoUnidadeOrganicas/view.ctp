<?php
    ...
    $this->Html->addCrumb(h($tipoUnidadeOrganica['TipoUnidadeOrganica']['name']),
            '/tipo_unidade_organicas/view/' . $tipoUnidadeOrganica['TipoUnidadeOrganica']['id']);
    $this->Html->addCrumb(__('Detalhes'),
            '/tipo_unidade_organicas/view/' . $tipoUnidadeOrganica['TipoUnidadeOrganica']['id']);
?>
