...
<div class="row">
    <div class="col-sm-12">
        ...
        <p>A comunidade Alumni-UEM ou simplesmente Alumni-UEM é uma congregação de graduados da UEM ou pessoas singulares e colectivas que se destacam na construção da UEM para ser o que é hoje, “uma universidade de referência nacional, regional e internacional na produção e disseminação do conhecimento científico e na inovação, destacando a investigação como alicerce dos processos de ensino-aprendizagem e extensão”. Ao preencher este formulário, disponibiliza-se a estabelecer um laço duradouro com a universidade que o formou, do qual mutuamente terão vários benefícios. Tu e a UEM precisam um do outro para crescer cada vez mais. Consulte o nosso seu portal: <b>http://alumni.uem.mz/</b></p>
    </div>
    <div class="col-sm-12">
