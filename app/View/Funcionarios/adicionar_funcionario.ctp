                    ...
                    <div id="step-2">
                        <div class="form-group">
                            <fieldset>
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <?php echo $this->Form->label('Funcionario.unidade_organica_id',
                                                'Unidade Organica'); ?>
                                    ...
                                    <div class="col-sm-4">
                                        <?php echo $this->Form->label('Funcionario.tipo_funcionario_id',
                                                'Tipo de Funcionario'); ?>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <?php echo $this->Form->label('Funcionario.grau_academico_id',
                                                'Grau Academico'); ?>
