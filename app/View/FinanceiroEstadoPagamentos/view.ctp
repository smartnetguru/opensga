...
<div class="actions">
    ...
    <ul>
        <li><?php echo $this->Html->link(__('Edit Financeiro Estado Pagamento'),
                    ['action' => 'edit', $financeiroEstadoPagamento['FinanceiroEstadoPagamento']['id']]); ?> </li>
        <li><?php echo $this->Form->postLink(__('Delete Financeiro Estado Pagamento'),
                    ['action' => 'delete', $financeiroEstadoPagamento['FinanceiroEstadoPagamento']['id']], null,
                    __('Are you sure you want to delete # %s?',
                            $financeiroEstadoPagamento['FinanceiroEstadoPagamento']['id'])); ?> </li>
