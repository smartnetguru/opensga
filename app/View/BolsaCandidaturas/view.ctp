    ...
    <dl>
        ...
        <dd>
            <?php echo $this->Html->link($bolsaCandidatura['AnoLectivo']['codigo'],
                    ['controller' => 'ano_lectivos', 'action' => 'view', $bolsaCandidatura['AnoLectivo']['id']]); ?>
            &nbsp;
        </dd>
        <dt><?php echo __('Bolsa Bolsa'); ?></dt>
        <dd>
            <?php echo $this->Html->link($bolsaCandidatura['BolsaBolsa']['id'],
                    ['controller' => 'bolsa_bolsas', 'action' => 'view', $bolsaCandidatura['BolsaBolsa']['id']]); ?>
            &nbsp;
        </dd>
        ...
        <dd>
            <?php echo $this->Html->link($bolsaCandidatura['Entidade']['name'],
                    ['controller' => 'entidades', 'action' => 'view', $bolsaCandidatura['Entidade']['id']]); ?>
            &nbsp;
        </dd>
...
<div class="actions">
    ...
    <ul>
        <li><?php echo $this->Html->link(__('Edit Bolsa Candidatura'),
                    ['action' => 'edit', $bolsaCandidatura['BolsaPedido']['id']]); ?> </li>
        <li><?php echo $this->Form->postLink(__('Delete Bolsa Candidatura'),
                    ['action' => 'delete', $bolsaCandidatura['BolsaPedido']['id']], null,
                    __('Are you sure you want to delete # %s?', $bolsaCandidatura['BolsaPedido']['id'])); ?> </li>
