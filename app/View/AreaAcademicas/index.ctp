        ...
        <div class="block-border">
            <div class="block-content">
                <ul class="shortcut-list">
                    <li>
                        <?php echo $this->Html->link($this->Html->image('icons/packs/crystal/48x48/apps/kedit.png') . __("Nova Área Académica"),
                                ['controller' => 'area_academicas', 'action' => 'add'], ['escape' => false]) ?>
                    </li>
                </ul>
                <div class="clear"></div>
            </div>
                            ...
                            <tr>
                                ...
                                <td class="actions">
                                    <?php echo $this->Html->link(__('Ver'),
                                            ['action' => 'view', $areaAcademica['AreaAcademica']['id']]); ?>
                                    <?php echo $this->Html->link(__('Editar'),
                                            ['action' => 'edit', $areaAcademica['AreaAcademica']['id']]); ?>
                                    <?php echo $this->Form->postLink(__('Remover'),
                                            ['action' => 'delete', $areaAcademica['AreaAcademica']['id']], null,
                                            __('Tem certeza que deseja remover # %s?',
                                                    $areaAcademica['AreaAcademica']['id'])); ?>
                                </td>
                            </tr>
                        <?php endforeach; ?>
