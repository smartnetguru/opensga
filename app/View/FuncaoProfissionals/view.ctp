...
<div class="actions">
    ...
    <ul>
        <li><?php echo $this->Html->link(__('Edit Funcao Profissional'),
                    ['action' => 'edit', $funcaoProfissional['FuncaoProfissional']['id']]); ?> </li>
        <li><?php echo $this->Form->postLink(__('Delete Funcao Profissional'),
                    ['action' => 'delete', $funcaoProfissional['FuncaoProfissional']['id']], null,
                    __('Are you sure you want to delete # %s?',
                            $funcaoProfissional['FuncaoProfissional']['id'])); ?> </li>
