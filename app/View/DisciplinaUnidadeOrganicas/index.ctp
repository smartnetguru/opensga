            ...
            <tr>
                ...
                <td class="actions">
                    <?php echo $this->Html->link(__('View'),
                            ['action' => 'view', $disciplinaUnidadeOrganica['DisciplinaUnidadeOrganica']['id']]); ?>
                    <?php echo $this->Html->link(__('Edit'),
                            ['action' => 'edit', $disciplinaUnidadeOrganica['DisciplinaUnidadeOrganica']['id']]); ?>
                    <?php echo $this->Form->postLink(__('Delete'),
                            ['action' => 'delete', $disciplinaUnidadeOrganica['DisciplinaUnidadeOrganica']['id']], [
                                    'confirm' => __('Are you sure you want to delete # %s?',
                                            $disciplinaUnidadeOrganica['DisciplinaUnidadeOrganica']['id']),
                            ]); ?>
                </td>
            </tr>
        <?php endforeach; ?>
