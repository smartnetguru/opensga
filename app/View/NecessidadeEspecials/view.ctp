...
<div class="actions">
    ...
    <ul>
        <li><?php echo $this->Html->link(__('Edit Necessidade Especial'),
                    ['action' => 'edit', $necessidadeEspecial['NecessidadeEspecial']['id']]); ?> </li>
        <li><?php echo $this->Form->postLink(__('Delete Necessidade Especial'),
                ...
                <tr>
                    ...
                    <td class="actions">
                        <?php echo $this->Html->link(__('View'), [
                                'controller' => 'entidade_necessidades',
                                'action'     => 'view',
                                $entidadeNecessidade['id'],
                        ]); ?>
                        ...
                        <?php echo $this->Form->postLink(__('Delete'), [
                                ...
                                'action'     => 'delete',
                                $entidadeNecessidade['id'],
                        ], ['confirm' => __('Are you sure you want to delete # %s?', $entidadeNecessidade['id'])]); ?>
                    </td>
                </tr>
            <?php endforeach; ?>
        </table>
