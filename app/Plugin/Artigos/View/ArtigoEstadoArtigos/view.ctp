...
<div class="actions">
    ...
    <ul>
        <li><?php echo $this->Html->link(__('Edit Artigo Estado Artigo'),
                    ['action' => 'edit', $artigoEstadoArtigo['ArtigoEstadoArtigo']['id']]); ?> </li>
        <li><?php echo $this->Form->postLink(__('Delete Artigo Estado Artigo'),
                ...
                <tr>
                    ...
                    <td class="actions">
                        <?php echo $this->Html->link(__('View'),
                                ['controller' => 'artigos', 'action' => 'view', $artigo['id']]); ?>
                        <?php echo $this->Html->link(__('Edit'),
                                ['controller' => 'artigos', 'action' => 'edit', $artigo['id']]); ?>
                        <?php echo $this->Form->postLink(__('Delete'),
                                ['controller' => 'artigos', 'action' => 'delete', $artigo['id']],
                                ['confirm' => __('Are you sure you want to delete # %s?', $artigo['id'])]); ?>
                    </td>
                </tr>
            <?php endforeach; ?>
        </table>
