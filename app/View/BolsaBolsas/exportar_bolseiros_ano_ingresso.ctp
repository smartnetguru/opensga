...
foreach ($bolsas as $bolsa) {
	...
	$this->PhpExcel->xls->getActiveSheet()->setCellValue('A' . $linhaActual, $bolsa['Entidade']['apelido']);
	$this->PhpExcel->xls->getActiveSheet()->setCellValue('B' . $linhaActual, $bolsa['Entidade']['nomes']);
	$this->PhpExcel->xls->getActiveSheet()->setCellValue('C' . $linhaActual, $bolsa['Curso']['name']);
	...
	$this->PhpExcel->xls->getActiveSheet()->setCellValue('F' . $linhaActual, $bolsa['Entidade']['Genero']['name']);
	$this->PhpExcel->xls->getActiveSheet()->setCellValue('G' . $linhaActual, $bolsa['Entidade']['data_nascimento']);
	$this->PhpExcel->xls->getActiveSheet()->setCellValue('H' . $linhaActual, $bolsa['Entidade']['ProvinciaNascimento']['name']);
	$this->PhpExcel->xls->getActiveSheet()->setCellValue('I' . $linhaActual, $bolsa['Aluno']['ano_ingresso']);
	$this->PhpExcel->xls->getActiveSheet()->setCellValue('J' . $linhaActual, '');
	$this->PhpExcel->xls->getActiveSheet()->setCellValue('K' . $linhaActual, $bolsa['Aluno']['codigo']);
	$this->PhpExcel->xls->getActiveSheet()->setCellValue('L' . $linhaActual, $bolsa['Entidade']['telemovel']);
	$linhaActual++;
}
