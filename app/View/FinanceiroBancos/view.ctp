...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Financeiro Banco'), array('action' => 'edit', $financeiroBanco['FinanceiroBanco']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Financeiro Banco'), array('action' => 'delete', $financeiroBanco['FinanceiroBanco']['id']), null, __('Are you sure you want to delete # %s?', $financeiroBanco['FinanceiroBanco']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('List Financeiro Bancos'), array('action' => 'index')); ?> </li>
