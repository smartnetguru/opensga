<?php
    ...
    $this->Html->addCrumb(__($this->request->data['Group']['name']), '/groups/ver_grupo/' . $this->params['pass'][0]);
    $this->Html->addCrumb(__('Editar Grupo'), '/groups/novo_grupo');
?>
<div class="container_12">
    <div class="grid_12">
        <div class="alert warning"><?php echo __('Atencao: Mudar o nome do Grupo fara que todos os utilizadores deste grupo passem a pertencer ao novo grupo') ?></div>
    </div>
    <div class="grid_6">
        <div class="block-border">
            ...
            <?php echo $this->Form->input('descricao',
                    ['label' => __('Descricao'), 'div' => '_100', 'class' => 'text']); ?>
            <div class="clear"></div>
            <div class="block-actions">
                <ul class="actions-left">
                    <li><?php echo $this->Html->link(__('Lista de Grupos'),
                                ['controller' => 'groups', 'action' => 'index'], ['class' => 'button red']) ?></li>
                </ul>
