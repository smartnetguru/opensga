...
<?php echo $this->Form->create('EstadoTurma'); ?>
	<fieldset>
		<legend><?php echo __('Edit Estado Turma'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('EstadoTurma.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('EstadoTurma.id'))); ?></li>
