...
class CakeResqueShellTest extends CakeTestCase
{
    ...
    public function setUp()
    {
        ...
        $this->Shell->expects($this->any())->method('_kill')->will($this->returnValue(array(
            'code' => 0,
            'message' => ''
        )));
    ...
    public function testSendSignalWithMultipleWorkers()
    {
        ...
        $this->Shell->params['all'] = false;
        $method->invoke($this->Shell, $args[0], $args[1], $args[2], $args[3], $args[4], $args[5], $args[6], $args[7],
    ...
    public function testSendSignalThatFail()
    {
        ...
        $shell->ResqueStatus = $this->ResqueStatus = $this->getMock(
            ...
            array(
                ...
                'isSchedulerWorker',
                'setPausedWorker',
                'isRunningSchedulerWorker',
                'getWorkers'
            ), array(new stdClass()));

        $shell->expects($this->once())->method('_kill')->will($this->returnValue(array(
            'code' => 1,
        ...
        $shell->params['all'] = false;
        $method->invoke($shell, $args[0], $args[1], $args[2], $args[3], $args[4], $args[5], $args[6], $args[7],
            $args[8], $args[9], $args[10]);
    }
