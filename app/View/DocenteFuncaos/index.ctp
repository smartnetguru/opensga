                ...
                <tr>
                    ...
                    <td class="actions">
                        <?php echo $this->Html->link(__('View'),
                                ['action' => 'view', $docenteFuncao['DocenteFuncao']['id']]); ?>
                        <?php echo $this->Html->link(__('Edit'),
                                ['action' => 'edit', $docenteFuncao['DocenteFuncao']['id']]); ?>
                        <?php echo $this->Form->postLink(__('Delete'),
                                ['action' => 'delete', $docenteFuncao['DocenteFuncao']['id']], null,
                                __('Are you sure you want to delete # %s?', $docenteFuncao['DocenteFuncao']['id'])); ?>
                    </td>
                </tr>
            <?php endforeach; ?>
    </table>
