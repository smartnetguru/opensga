...
<div class="action-list">
    ...
    <div class="col-sm-2">
        <?php echo $this->Html->link('<i class="fa fa-user fa-2x"></i>Carregar Ficheiro de Renovação',
            array('controller' => 'matriculas', 'action' => 'carregar_ficheiro_renovacao'), array('escape' => false,
                                                                              'class' => 'btn btn-icon btn-block')) ?>
    </div>
	<div class="col-sm-2">
		<?php echo $this->Html->link('<i class="fa fa-refresh  fa-2x"></i>	Fazer Reingresso', array('controller' => 'alunos', 'action' => 'pesquisa_aluno_action', 'fazer_reingresso', 'matriculas'), array('escape' => false, 'class' => 'btn btn-icon btn-block')) ?>
	</div>
	<div class="col-sm-2">
