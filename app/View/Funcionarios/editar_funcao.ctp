...
<div class="container_12">
        ...
        <div class="block-border">
            <div class="block-content">
                <ul class="shortcut-list">
                    <li>
                        <?php echo $this->Html->link($this->Html->image('icons/student/edit-student.png') . "Editar Perfil", array('controller' => 'funcionarios', 'action' => 'editar_funcionario', $funcionario['Funcionario']['id']), array('escape' => false)) ?>
                    </li>
                    <li>
                        <?php echo $this->Html->link($this->Html->image('icons/packs/crystal/48x48/apps/printer.png') . "Alterar/Adicionar Função", array('controller' => 'funcionarios', 'action' => 'editar_funcao', $funcionario['Funcionario']['id']), array( 'escape' => false)) ?>
                    </li>
    ...
    <div class="grid_6">
        <div class="block-border" id="tab-panel-2">
            <?php echo $this->Form->create('Aluno', array('enctype' => 'multipart/form-data', 'class' => 'block-content form')); ?>
            ...
            <fieldset>
                ...
                <div class="_30">
                    <p><label for="textfield">Data de Nascimento</label>
                        <span class="data-data"><?php echo $this->Print->printField($funcionario['Entidade']['data_nascimento']); ?></span></p>
                </div>
                <div class="_30">
                    <p><label for="textfield">Sexo</label>
                        <span class="data-data"><?php echo $this->Print->printField($funcionario['Entidade']['Genero']['name']); ?></span></p>
                </div>
                <div class="_50">
                ...
                <div class="_30">
                    <p><label for="textfield">Nacionalidade</label>
                        <span class="data-data"><?php echo $this->Print->printField($funcionario['Entidade']['PaisNascimento'],'name'); ?></span>
                </div>
                <div class="_30">
                ...
                <div class="_30">
                    <p><label for="textfield">Tipo/Nr DocumentoIdentificacao de Identidade</label>
                        <span class="data-data"><?php echo $this->Print->printField($funcionario['Entidade']['DocumentoIdentificacao'],'name') . "/" . $this->Print->printField($funcionario['Entidade']['documento_identificacao_num']); ?></span>
                </div>
                <div class="_30">
    ...
    <div class="grid_6">
            <div class="block-border">
                ...
                <?php echo $this->Form->create('FuncionariosFuncaoProfissional', array('class' => 'block-content form', 'inputDefaults' => array('before' => '<p>', 'after' => '</p>'))); ?>
                <?php echo $this->Form->input('funcao_profissional_id', array('label' => __('Documento/Tipo de Requisição'), 'div' => '_50', 'class' => 'required', 'size' => 45,'default'=>1)); ?>
                <?php echo $this->Form->input('nova_funcao_funcionario', array('label' => __('Outros tipos de Requisição'), 'div' => '_50', 'class' => 'text')); ?>
