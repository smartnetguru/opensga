...
//            }
    ...
    public function docente_index($alunoId) {
        ...
        $turmasDocente = $this->Aluno->Inscricao->Turma->DocenteTurma->find('all', array('conditions' => array('DocenteTurma.docente_id' => $docente['Docente']['id'], 'DocenteTurma.estado_docente_turma_id' => 1)));
