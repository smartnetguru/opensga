<?php
App::uses('RegimeEstudo', 'Model');

/**
 * RegimeEstudo Test Case
 *
 */
class RegimeEstudoTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->RegimeEstudo = ClassRegistry::init('RegimeEstudo');
	}
