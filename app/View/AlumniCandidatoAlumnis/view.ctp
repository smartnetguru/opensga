<div class="candidatoAlumnis view">
    ...
    <dl>
        ...
        <dd>
            <?php echo $this->Html->link($candidatoAlumni['Genero']['name'],
                    ['controller' => 'generos', 'action' => 'view', $candidatoAlumni['Genero']['id']]); ?>
            &nbsp;
        </dd>
        <dt><?php echo __('Estado Civil'); ?></dt>
        <dd>
            <?php echo $this->Html->link($candidatoAlumni['EstadoCivil']['name'],
                    ['controller' => 'estado_civils', 'action' => 'view', $candidatoAlumni['EstadoCivil']['id']]); ?>
            &nbsp;
        </dd>
        ...
        <dd>
            <?php echo $this->Html->link($candidatoAlumni['UnidadeOrganica']['name'], [
                    'controller' => 'unidade_organicas',
                    'action'     => 'view',
                    $candidatoAlumni['UnidadeOrganica']['id'],
            ]); ?>
            &nbsp;
        </dd>
        ...
        <dd>
            <?php echo $this->Html->link($candidatoAlumni['GrauAcademico']['name'], [
                    'controller' => 'grau_academicos',
                    'action'     => 'view',
                    $candidatoAlumni['GrauAcademico']['id'],
            ]); ?>
            &nbsp;
        </dd>
...
<div class="actions">
    ...
    <ul>
        <li><?php echo $this->Html->link(__('Edit Candidato Alumni'),
                    ['action' => 'edit', $candidatoAlumni['AlumniCandidatoAlumni']['id']]); ?> </li>
        <li><?php echo $this->Form->postLink(__('Delete Candidato Alumni'),
                    ['action' => 'delete', $candidatoAlumni['AlumniCandidatoAlumni']['id']], null,
                    __('Are you sure you want to delete # %s?',
                            $candidatoAlumni['AlumniCandidatoAlumni']['id'])); ?> </li>
        <li><?php echo $this->Html->link(__('List Candidato Alumnis'), ['action' => 'index']); ?> </li>
        <li><?php echo $this->Html->link(__('New Candidato Alumni'), ['action' => 'add']); ?> </li>
                    ...
                    <tr>
                        ...
                        <td class="actions">
                            <?php echo $this->Html->link(__('View'),
                                    ['controller' => 'alumnis', 'action' => 'view', $alumni['id']]); ?>
                            <?php echo $this->Html->link(__('Edit'),
                                    ['controller' => 'alumnis', 'action' => 'edit', $alumni['id']]); ?>
                            <?php echo $this->Form->postLink(__('Delete'),
                                    ['controller' => 'alumnis', 'action' => 'delete', $alumni['id']], null,
                                    __('Are you sure you want to delete # %s?', $alumni['id'])); ?>
                        </td>
                    </tr>
                <?php endforeach; ?>
        </table>
