...
class CandidatoShell extends AppShell
{
    ...
    public $uses = ['User', 'Candidatura', 'Curso', 'Entidade'];
    ...
    public function importa_admitidos_server()
    {
        ...
        $xls = PHPExcel_IOFactory::load(APP . 'Imports' . DS . 'Admitidos' . DS . '2016' . DS . 'admitidos_201502.xlsx');
    ...
    public function importaCandidatosSQL()
    {
        ...
        foreach ($candidatos as $candidato) {
            ...
            if (in_array($tipoDocumento, [
                'Bilhete de Identidade',
                'bi',
                'B.I',
                'Bilheite de Identidade',
                'bilhete de
            identificação',
                'Bilhete de indentidade',
                'B.I.',
                'bilhete identidade',
                'Bilhete',
                'BI',
                ...
                $tipoDocumentoId = 2;
            } elseif (in_array($tipoDocumento, [
                'Talão de Bilhete de Identidade',
                'TalÃ£o de Bilhete de Identidade',
                'Recibo de Bi',
                'espera BI',
                'Talão de BI',
                'talão',
            ...
            $distritoNascimentoDB = $this->Entidade->CidadeNascimento->find('first', [
                'conditions' => [
                    'name
            ...
            $distritoResidenciaDB = $this->Entidade->CidadeNascimento->find('first', [
                'conditions' => [
                    'name
            LIKE' => '%' . $distritoNascimento . '%',
                ],
