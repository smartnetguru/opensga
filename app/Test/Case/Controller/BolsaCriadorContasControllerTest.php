<?php
App::uses('BolsaCriadorContasController', 'Controller');

/**
 * BolsaCriadorContasController Test Case
 *
 */
class BolsaCriadorContasControllerTest extends ControllerTestCase {
