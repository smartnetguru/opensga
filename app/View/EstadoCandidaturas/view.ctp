...
<div class="actions">
    ...
    <ul>
        <li><?php echo $this->Html->link(__('Edit Estado Candidatura'),
                    ['action' => 'edit', $estadoCandidatura['EstadoCandidatura']['id']]); ?> </li>
        <li><?php echo $this->Form->postLink(__('Delete Estado Candidatura'),
                    ['action' => 'delete', $estadoCandidatura['EstadoCandidatura']['id']], null,
                    __('Are you sure you want to delete # %s?',
                            $estadoCandidatura['EstadoCandidatura']['id'])); ?> </li>
