...
{
    public $helpers = ['Auditable.Auditor', 'Time'];
    public $paginate = [
    ...
    public function index()
    {
        ...
        $logs = $this->Logger->find('all', ['conditions' => [], 'limit' => 1000, 'order' => 'Logger.created DESC']);
    ...
    public function admin_index($filter = null)
    {
        ...
        $logs = $this->Log->find('all', ['limit' => 25, 'order' => 'created DESC']);
    ...
    public function admin_delete($id = null)
    {
        ...
        if ($this->Log->deleteAll(['Log.message' => $log['Log']['message']])) {
