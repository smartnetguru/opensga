                ...
                <tr>
                    ...
                    <td>
                        <?php echo $this->Html->link($sadeAvaliacao['AnoLectivo']['codigo'], [
                                ...
                                'action'     => 'view',
                                $sadeAvaliacao['AnoLectivo']['id'],
                        ]); ?>
                    </td>
                    <td class="actions">
                        <?php echo $this->Html->link(__('View'),
                                ['action' => 'view', $sadeAvaliacao['SadeAvaliacao']['id']]); ?>
                        <?php echo $this->Html->link(__('Edit'),
                                ['action' => 'edit', $sadeAvaliacao['SadeAvaliacao']['id']]); ?>
                        <?php echo $this->Form->postLink(__('Delete'),
                                ['action' => 'delete', $sadeAvaliacao['SadeAvaliacao']['id']], null,
                                __('Are you sure you want to delete # %s?', $sadeAvaliacao['SadeAvaliacao']['id'])); ?>
                    </td>
                </tr>
            <?php endforeach; ?>
    </table>
