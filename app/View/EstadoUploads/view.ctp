...
<div class="actions">
    ...
    <ul>
        <li><?php echo $this->Html->link(__('Edit Estado Upload'),
                    ['action' => 'edit', $estadoUpload['EstadoUpload']['id']]); ?> </li>
        <li><?php echo $this->Form->postLink(__('Delete Estado Upload'),
                    ['action' => 'delete', $estadoUpload['EstadoUpload']['id']], null,
                    __('Are you sure you want to delete # %s?', $estadoUpload['EstadoUpload']['id'])); ?> </li>
        <li><?php echo $this->Html->link(__('List Estado Uploads'), ['action' => 'index']); ?> </li>
