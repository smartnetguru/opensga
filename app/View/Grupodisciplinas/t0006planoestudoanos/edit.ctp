...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('DisciplinaPlanoEstudo.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('DisciplinaPlanoEstudo.id'))); ?></li>
