<div class="regimeEstudos view">
<h2><?php echo __('Regime Estudo'); ?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($regimeEstudo['RegimeEstudo']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Name'); ?></dt>
		<dd>
			<?php echo h($regimeEstudo['RegimeEstudo']['name']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Regime Estudo'), array('action' => 'edit', $regimeEstudo['RegimeEstudo']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Regime Estudo'), array('action' => 'delete', $regimeEstudo['RegimeEstudo']['id']), null, __('Are you sure you want to delete # %s?', $regimeEstudo['RegimeEstudo']['id'])); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($regimeEstudo['CandidatoGraduacao'])): ?>
	...
	<?php foreach ($regimeEstudo['CandidatoGraduacao'] as $candidatoGraduacao): ?>
		<tr>
