...
<?php echo $this->Form->create('User', ['role' => 'form', 'class' => '', 'inputDefaults' => []]); ?>
    ...
    <div class="form-group">
        <label class="checkbox-inline">
            <?php echo $this->Form->input('usar_senha_padrao', [
                    'type'  => 'checkbox',
                    'label' => false,
                    'div'   => false,
                    'class' => 'green',
                    'id'    => 'definir_senha_padrao',
            ]); ?>
        </label>
        <label>
        ...
        <div>
            <?php echo $this->Form->input('senha_padrao',
                    ['label' => false, 'div' => false, 'class' => 'form-control', 'value' => $defaultPassword]); ?>
        </div>
    </div>
    <div class="form-group">
        <div class="col-sm-2">
