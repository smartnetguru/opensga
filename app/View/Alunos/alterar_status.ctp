...
<?php echo $this->Form->create('Aluno',
    ...
    <div class="form-group">
        ...
        <?php echo $this->Form->input('estado_actual', [
                'label'   => false,
                'div'     => false,
                'class'   => 'form-control search-select',
                'options' => $estadoAlunos,
        ]); ?>
    </div>
    <div class="form-group">
        <label>
        ...
        <div>
            <?php echo $this->Form->input('motivo_estado_aluno_id',
    ...
    <div class="form-group">
        <div class="col-sm-2 col-sm-offset-8">
            ...
            <?php echo $this->Form->hidden('estado_anterior', ['value' => $aluno['Aluno']['estado_aluno_id']]); ?>
