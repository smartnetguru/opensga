...
<div class="action-list">
	...
	<div class="col-sm-2">
		<?php echo $this->Html->link('<br/><i class="fa fa-plus"></i>	Adicionar Estudante <span class="badge badge-danger"> Brevemente </span>', array('controller' => 'alunos', 'action' => 'adicionar_estudante'), array('escape' => false, 'class' => 'btn btn-icon btn-block')) ?>
	</div>
	<div class="col-sm-2">
...
foreach ($alunos as $aluno):
	...
	<tr>
		...
		<td><?php echo $this->Form->postLink('Confirmar Matricula',array('action'=>'matriculados_pela_faculdade','mode'=>'confirmar','aluno_id'=>$aluno['Aluno']['id']),array('confirm'=>'Deseja Confirmar a matricula de '.$aluno['Entidade']['name'].'?','class'=>'btn btn-success'))?></td>
