            ...
            <tr>
                ...
                <td>
                    <?php echo $this->Html->link($groupsUser['EstadoObjecto']['name'], [
                            ...
                            'action'     => 'view',
                            $groupsUser['EstadoObjecto']['id'],
                    ]); ?>
                </td>
                <td class="actions">
                    <?php echo $this->Html->link(__('View'), ['action' => 'view', $groupsUser['GroupsUser']['id']]); ?>
                    <?php echo $this->Html->link(__('Edit'), ['action' => 'edit', $groupsUser['GroupsUser']['id']]); ?>
                    <?php echo $this->Form->postLink(__('Delete'),
                            ['action' => 'delete', $groupsUser['GroupsUser']['id']], null,
                            __('Are you sure you want to delete # %s?', $groupsUser['GroupsUser']['id'])); ?>
                </td>
            </tr>
        <?php endforeach; ?>
    </table>
