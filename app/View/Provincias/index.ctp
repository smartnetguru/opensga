...
<div class="projectos index" id="center-column">
    <div class="top-bar">
        <?php echo $this->Html->link(sprintf(__('Nova Provincia', true)), ['action' => 'add'],
                ['class' => 'button']); ?>
            ...
            <?php
                ...
                foreach ($provincias as $provincia):
                    ...
                    <tr<?php echo $class; ?>>
                        ...
                        <td>
                            <?php echo $this->Html->link($provincia['Paise']['name'],
                                    ['controller' => 'Paises', 'action' => 'view', $provincia['Paise']['id']]); ?>

                        <td class="accoes">
                            <?php echo $this->Html->image("/img/login-icon.gif", [
                                    "alt"   => "Brownies",
                                    "title" => "Visualizar",
                                    'url'   => ['action' => 'view', $provincia['Provincia']['id']],
                            ]); ?>
                            <?php echo $this->Html->image("/img/edit-icon.gif", [
                                    "alt"   => "Brownies",
                                    "title" => "Editar",
                                    'url'   => ['action' => 'edit', $provincia['Provincia']['id']],
                            ]); ?>
                            <?php echo $this->Html->image("/img/hr.gif", [
                                    "alt"   => "Brownies",
                                    "title" => "Apagar",
                                    'url'   => ['action' => 'delete', $provincia['Provincia']['id']],
                                    null,
