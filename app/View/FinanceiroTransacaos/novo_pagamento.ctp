...
<?php echo $this->Form->create('FinanceiroTransacao', array('class' => 'block-content form')); ?>
                ...
                <div class="_100">
                    <p><label for="textfield"><?php echo __('Número de Comprovativo') ?></label><?php echo $this->Form->input('FinanceiroDeposito.numero_comprovativo', array('label' => false, 'div' => false, 'class' => 'required', 'empty' => '--seleccione--')); ?></p>
                </div>
                <div class="_50">
                ...
                <div class="_75">
                    <p><label for="textfield"><?php echo __('Valor Depositado') ?></label><?php echo $this->Form->input('FinanceiroTransacao.valor', array('label' => false, 'div' => false, 'class' => 'required', 'empty' => '--seleccione--')); ?></p>
                </div>
                <div class="_25">
                    <p><label for="textfield"><?php echo __('Data do Depósito') ?></label><?php echo $this->Form->input('FinanceiroDeposito.data_deposito', array('label' => false, 'div' => false, 'class' => 'required', 'type' => 'text', 'id' => 'dataPagamento')); ?></p>
                </div>
                <div class="_100">
...
<?php echo $this->Form->input('FinanceiroTransacao.aluno_id', array('type' => 'hidden', 'value' => $aluno_id)) ?>
                <div class="clear"></div>
                <div class="block-actions">
                    <ul class="actions-left">
