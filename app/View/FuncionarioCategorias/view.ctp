...
<div class="actions">
    ...
    <ul>
        <li><?php echo $this->Html->link(__('Edit Funcionario Categoria'),
                    ['action' => 'edit', $funcionarioCategoria['FuncionarioCategoria']['id']]); ?> </li>
        <li><?php echo $this->Form->postLink(__('Delete Funcionario Categoria'),
                ...
                <tr>
                    ...
                    <td class="actions">
                        ...
                        <?php echo $this->Form->postLink(__('Delete'),
                                ...
                                ['confirm' => __('Are you sure you want to delete # %s?', $funcionario['id'])]); ?>
                    </td>
                </tr>
            <?php endforeach; ?>
        </table>
