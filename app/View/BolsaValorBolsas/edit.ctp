...
<?php echo $this->Form->create('BolsaValorBolsa'); ?>
	<fieldset>
		<legend><?php echo __('Edit Bolsa Valor Bolsa'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('BolsaValorBolsa.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('BolsaValorBolsa.id'))); ?></li>
