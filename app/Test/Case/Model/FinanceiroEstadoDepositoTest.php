<?php
App::uses('FinanceiroEstadoDeposito', 'Model');

/**
 * FinanceiroEstadoDeposito Test Case
 *
 */
class FinanceiroEstadoDepositoTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->FinanceiroEstadoDeposito = ClassRegistry::init('FinanceiroEstadoDeposito');
	}
 ...
 */
	public function tearDown() {
		unset($this->FinanceiroEstadoDeposito);
