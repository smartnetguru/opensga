...
<div class="actions">
    ...
    <ul>
        <li><?php echo $this->Html->link(__('Edit Regime Lectivo'),
                    ['action' => 'edit', $regimeLectivo['RegimeLectivo']['id']]); ?> </li>
        <li><?php echo $this->Form->postLink(__('Delete Regime Lectivo'),
                    ['action' => 'delete', $regimeLectivo['RegimeLectivo']['id']], [],
                    __('Are you sure you want to delete # %s?', $regimeLectivo['RegimeLectivo']['id'])); ?> </li>
