    ...
    class AlunosController extends AppController
    {
        ...
        public function adicionar_estudante()
        {
            ...
            $this->set(compact('grauParentescos', 'simNaoRespostas', 'naturalidade', 'nacionalidades', 'cursos',
                'planoestudos', 'unidadeOrganicas', 'paises', 'cidadeNascimentos', 'provincias',
                'documento_identificacaos',
        ...
        public function cerimonia_graduacao($aluno_id)
        {
            if ($this->request->is('post')) {
                ...
                $this->Aluno->Entidade->set('estado_civil',
                    $this->request->data['CandidatoGraduacao']['estado_civil_id']);
        ...
        .aluno_id' => $alunoId,
            ...
            $this->set(compact('inscricoes_activas', 'todas_inscricoes', 'cadeiras_aprovadas', 'pagamentos',
                'is_bolseiro',
...
//            }
         ...
         *
         * Esta funcao nao verifica se o aluno pertence a determinada faculdade
         *
         * @param type $action_seguinte
         * @param type $controller
         * @param type $plugin
         */
        public function faculdade_pesquisa_aluno_externo_action($actionSeguinte, $controller = null, $plugin = null)
        {
        ...
        public function matricular_candidato($candidato_id)
        {
            ...
            if ($this->request->is('post')) {
                ...
                if ($this->Aluno->matriculaNovoIngresso($this->request->data)) {
                    $this->Session->setFlash("Aluno Registrado com Sucesso", 'default',
                        ['class' => 'alert alert-success']);
                    $this->redirect(['controller' => 'alunos', 'action' => 'perfil_estudante', $this->Aluno->id]);
                } else {
                    $this->Session->setFlash('Problemas ao registrar os dados do Aluno', 'default',
