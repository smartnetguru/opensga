...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Sade Avaliacao Qualitativa'), array('action' => 'edit', $sadeAvaliacaoQualitativa['SadeAvaliacaoQualitativa']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Sade Avaliacao Qualitativa'), array('action' => 'delete', $sadeAvaliacaoQualitativa['SadeAvaliacaoQualitativa']['id']), null, __('Are you sure you want to delete # %s?', $sadeAvaliacaoQualitativa['SadeAvaliacaoQualitativa']['id'])); ?> </li>
