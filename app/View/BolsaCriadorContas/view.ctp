...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Bolsa Criador Conta'), array('action' => 'edit', $bolsaCriadorConta['BolsaCriadorConta']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Bolsa Criador Conta'), array('action' => 'delete', $bolsaCriadorConta['BolsaCriadorConta']['id']), null, __('Are you sure you want to delete # %s?', $bolsaCriadorConta['BolsaCriadorConta']['id'])); ?> </li>
