...
<div class="actions">
    ...
    <ul>
        <li><?php echo $this->Html->link(__('Edit Banco'), ['action' => 'edit', $banco['Banco']['id']]); ?> </li>
        <li><?php echo $this->Form->postLink(__('Delete Banco'), ['action' => 'delete', $banco['Banco']['id']], null,
                    __('Are you sure you want to delete # %s?', $banco['Banco']['id'])); ?> </li>
        <li><?php echo $this->Html->link(__('List Bancos'), ['action' => 'index']); ?> </li>
        <li><?php echo $this->Html->link(__('New Banco'), ['action' => 'add']); ?> </li>
...
<div class="related">
    ...
    <?php if (!empty($banco['BolsaBolsa'])): ?>
        <table cellpadding="0" cellspacing="0">
            ...
            <?php
                $i = 0;
                foreach ($banco['BolsaBolsa'] as $bolsaBolsa): ?>
                    <tr>
