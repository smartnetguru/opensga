                        ...
                        <tbody>
                            ...
                            foreach ($unidadeOrganicas as $unidadeOrganica):
                                ...
                                <tr class="<?php echo $class ?>">
                                    <td><?php echo $this->Html->link(h($unidadeOrganica['UnidadeOrganica']['codigo']),array('action'=>'ver_unidade_organica',$unidadeOrganica['UnidadeOrganica']['id'])); ?>&nbsp;</td>
                                    <td><?php echo $this->Html->link(h($unidadeOrganica['UnidadeOrganica']['name']),array('action'=>'ver_unidade_organica',$unidadeOrganica['UnidadeOrganica']['id'])); ?>&nbsp;</td>
