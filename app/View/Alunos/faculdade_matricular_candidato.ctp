        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <?php echo $this->Form->create('Aluno', array(
                    ...
                    'id' => 'form',
                    'inputDefaults' => array('empty' => 'Seleccione', 'placeholder' => 'Seleccione')
                )); ?>
                ...
                <div class="swMain" id="wizard">
                            ...
                            <fieldset>
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        ...
                                        <?php echo $this->Form->input('Aluno.codigo', array(
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <?php echo $this->Form->input('Entidade.apelido', array(
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <?php echo $this->Form->input('Entidade.nomes', array(
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <?php echo $this->Form->input('Candidatura.nome_faculdade', array(
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <?php echo $this->Form->input('Candidatura.nome_curso', array(
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <?php echo $this->Form->input('Entidade.data_nascimento', array(
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <?php echo $this->Form->input('Entidade.nome_pai', array(
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <?php echo $this->Form->input('Entidade.nome_mae', array(
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <?php echo $this->Form->input('Entidade.pais_nascimento', array(
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <?php echo $this->Form->input('Entidade.provincia_nascimento', array(
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <?php echo $this->Form->input('Entidade.cidade_nascimento', array(
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <?php echo $this->Form->label('AlunoNivelMedio.EscolaNivelMedio.pais_id',
                                            'Pais de Origem'); ?>
                                        <?php echo $this->Form->input('AlunoNivelMedio.EscolaNivelMedio.pais_id', array(
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <?php echo $this->Form->label('AlunoNivelMedio.escola_nivel_medio_id',
                                            'Escola de Conclusao'); ?>
                                        <?php echo $this->Form->input('AlunoNivelMedio.escola_nivel_medio_id', array(
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <?php echo $this->Form->label('AlunoNivelMedio.ano_conclusao',
                                            'Ano de Conclusao'); ?>
                                        <?php echo $this->Form->input('AlunoNivelMedio.ano_conclusao', array(
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <?php echo $this->Form->label('AlunoNivelMedio.nota_final',
                                            'Nota de Conclusao'); ?>
                                        <?php echo $this->Form->input('AlunoNivelMedio.nota_final', array(
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <?php echo $this->Form->input('EntidadeContacto.2', array(
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <?php echo $this->Form->label('EntidadeIdentificacao.numero',
                                            'Numero de Documento'); ?>
                                        <?php echo $this->Form->input('EntidadeIdentificacao.numero', array(
                    ...
                    <div id="step-4">
                        ...
                        <div class="row">
                            ...
                            <?php echo $this->Form->input('Aluno.curso_id', array(
                                'type' => 'hidden',
                            ...
                            <?php echo $this->Form->input('Aluno.unidade_organica_id', array(
                                'type' => 'hidden',
                                'value' => $candidato['Candidatura']['curso_id'],
                                'label' => false,
                                'div' => '_30',
                            ...
                            <?php echo $this->Form->input('Aluno.numero_estudante', array(
                                'type' => 'hidden',
                                'value' => $candidato['Candidatura']['numero_estudante'],
                                'label' => false,
                                'div' => '_30',
                            ...
                            <?php echo $this->Form->input('Aluno.aluno_via_admissao_id', array(
                                'type' => 'hidden',
                            ...
                            <?php echo $this->Form->input('Aluno.ano_ingresso', array(
                                'type' => 'hidden',
...
echo $this->Html->script('/assets/js/form-matricular-candidato-elements', array('block' => 'scriptBottom'),
    array('block' => 'scriptBottom'));
echo $this->Html->script('/assets/js/form-matricular-candidato-wizard', array('block' => 'scriptBottom'),
    array('block' => 'scriptBottom'));
?>
