        ...
        <div class="col-sm-12">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <?php echo $this->Form->create('Aluno', ['role' => 'form', 'class' => 'form-horizontal']); ?>
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <?php echo $this->Form->input('codigo', [
                                    ...
                                    'div'         => false,
                                    'class'       => 'form-control',
                                    'placeholder' => 'digite o numero de estudante aqui',
                            ]); ?>
                            <?php echo $this->Form->input('actionSeguinte', [
                                    'type'  => 'hidden',
                                    'value' => $actionSeguinte,
