<?php
App::uses('FuncaoProfissionalRolesController', 'Controller');

/**
 * FuncaoProfissionalRolesController Test Case
 *
 */
class FuncaoProfissionalRolesControllerTest extends ControllerTestCase {
