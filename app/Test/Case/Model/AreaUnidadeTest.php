<?php
App::uses('AreaUnidade', 'Model');

/**
 * AreaUnidade Test Case
 *
 */
class AreaUnidadeTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->AreaUnidade = ClassRegistry::init('AreaUnidade');
	}
