...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Bolsa Pedido'), array('action' => 'edit', $bolsaPedido['BolsaPedido']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Bolsa Pedido'), array('action' => 'delete', $bolsaPedido['BolsaPedido']['id']), array(), __('Are you sure you want to delete # %s?', $bolsaPedido['BolsaPedido']['id'])); ?> </li>
	...
	<?php foreach ($bolsaPedido['BolsaBolsa'] as $bolsaBolsa): ?>
		<tr>
			...
			<td class="actions">
				...
				<?php echo $this->Form->postLink(__('Delete'), array('controller' => 'bolsa_bolsas', 'action' => 'delete', $bolsaBolsa['id']), array(), __('Are you sure you want to delete # %s?', $bolsaBolsa['id'])); ?>
			</td>
		</tr>
	<?php endforeach; ?>
	</table>
