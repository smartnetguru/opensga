...
<?php echo $this->Form->create('Matricula', array('role' => 'form', 'class' => '')); ?>
<div class="row">
	...
	foreach ($renovacoesFalta as $rf) {
		...
		<div class="form-group col-sm-10">
			<div class="checkbox">
				<label><?php
					echo $this->Form->input('AnoLectivo.' . $rf['AnoLectivo']['id'], array('type' => 'checkbox', 'value' => $rf['AnoLectivo']['id'], 'label' => false, 'div' => false, 'style' => 'position: absolute; top: -10%; left: -10%; display: block; width: 120%; height: 120%; margin: 0px; padding: 0px; background: none repeat scroll 0% 0% rgb(255, 255, 255); border: 0px none; opacity: 0;'));
		...
		echo $this->Form->input('tipo_matricula_id', array('type' => 'hidden', 'value' => 2, 'label' => false, 'div' => '_50'));
		echo $this->Form->input('regime_lectivo_id', array('type' => 'hidden', 'value' => null, 'label' => false, 'div' => '_50'));
	}
	?>

	<div class="form-group col-sm-10">
		<?php echo $this->Form->end(array('label' => __('GRAVAR', true), 'class' => 'butn btn-blue')); ?>
	</div>
</div>
<?php $this->end(); ?>
