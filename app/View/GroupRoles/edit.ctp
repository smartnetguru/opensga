...
<div class="actions">
    ...
    <ul>
        ...
        <li><?php echo $this->Form->postLink(__('Delete'), ['action' => 'delete', $this->Form->value('GroupRole.id')],
                    null, __('Are you sure you want to delete # %s?', $this->Form->value('GroupRole.id'))); ?></li>
