<?php
App::uses('UnidadeOrganicaRolesController', 'Controller');

/**
 * UnidadeOrganicaRolesController Test Case
 *
 */
class UnidadeOrganicaRolesControllerTest extends ControllerTestCase {
