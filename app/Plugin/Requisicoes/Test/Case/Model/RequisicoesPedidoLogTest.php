<?php
App::uses('RequisicoesPedidoLog', 'Requisicoes.Model');

/**
 * RequisicoesPedidoLog Test Case
 *
 */
class RequisicoesPedidoLogTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->RequisicoesPedidoLog = ClassRegistry::init('Requisicoes.RequisicoesPedidoLog');
	}
 ...
 */
	public function tearDown() {
		unset($this->RequisicoesPedidoLog);
