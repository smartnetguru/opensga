...
<div class="actions">
    ...
    <ul>
        <li><?php echo $this->Html->link(__('Edit Sms Notification Type'),
                    ['action' => 'edit', $smsNotificationType['SmsNotificationType']['id']]); ?> </li>
        <li><?php echo $this->Form->postLink(__('Delete Sms Notification Type'),
                    ['action' => 'delete', $smsNotificationType['SmsNotificationType']['id']], null,
                    __('Are you sure you want to delete # %s?',
                            $smsNotificationType['SmsNotificationType']['id'])); ?> </li>
                    ...
                    <tr>
                        ...
                        <td class="actions">
                            ...
                            <?php echo $this->Form->postLink(__('Delete'),
                                    ['controller' => 'sms_notifications', 'action' => 'delete', $smsNotification['id']],
                                    null, __('Are you sure you want to delete # %s?', $smsNotification['id'])); ?>
                        </td>
                    </tr>
                <?php endforeach; ?>
        </table>
