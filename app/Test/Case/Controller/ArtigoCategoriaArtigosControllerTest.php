<?php
App::uses('ArtigoCategoriaArtigosController', 'Controller');

/**
 * ArtigoCategoriaArtigosController Test Case
 */
class ArtigoCategoriaArtigosControllerTest extends ControllerTestCase {
